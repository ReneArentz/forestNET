    ...
    public class YAMLUnitTest
    {
        ...
        public void TestYAML()
        {
            try
            {
                ...
                string s_testDirectory = s_currentDirectory + ForestNET.Lib.IO.File.DIR + "testYAML" + ForestNET.Lib.IO.File.DIR;
        ...
        private static void YamlValidate()
        {
            ...
            string s_yamlSchemaFile = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + "TestYAMLSchemaClassRootWithRef.yaml";
            string s_yamlFile = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + "ValidateYAML.yaml";
            string s_invalidYamlFile = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + "ValidateYAMLIsInvalid.yaml";

            Assert.That(
                new ForestNET.Lib.IO.YAML(s_yamlSchemaFile, 4).ValidateAgainstSchema(s_yamlFile),
                    Is.True,
            ...
            {
                Assert.That(
                    new ForestNET.Lib.IO.YAML(s_yamlSchemaFile, 4).ValidateAgainstSchema(s_invalidYamlFile),
                    Is.False,
        ...
        private static void YamlVirtualFiles()
        {
            ...
            ForestNET.Lib.IO.YAML.YAMLElement o_yamlSchema = new("Root")
            {
                Type = "object",
                MappingClass = "ForestNET.Tests.SQL.AllTypesRecord, ForestNET.Tests"
            };

            ForestNET.Lib.IO.YAML.YAMLElement o_yamlElement = new("Id")
            {
                Type = "integer",
            ...
            o_yamlElement = new ForestNET.Lib.IO.YAML.YAMLElement("UUID")
            {
                Type = "string",
            ...
            o_yamlElement = new ForestNET.Lib.IO.YAML.YAMLElement("ShortText")
            {
                Type = "string",
            ...
            o_yamlElement = new ForestNET.Lib.IO.YAML.YAMLElement("Text")
            {
                Type = "string",
            ...
            o_yamlElement = new ForestNET.Lib.IO.YAML.YAMLElement("SmallInt")
            {
                Type = "integer",
            ...
            o_yamlElement = new ForestNET.Lib.IO.YAML.YAMLElement("Int")
            {
                Type = "integer",
            ...
            o_yamlElement = new ForestNET.Lib.IO.YAML.YAMLElement("BigInt")
            {
                Type = "integer",
            ...
            o_yamlElement = new ForestNET.Lib.IO.YAML.YAMLElement("LocalDateTime")
            {
                Type = "string",
            ...
            ForestNET.Lib.IO.YAML o_yaml = new(o_yamlSchema, 4);
            ...
            ForestNET.Tests.SQL.AllTypesRecord? o_recordIn = (ForestNET.Tests.SQL.AllTypesRecord?)o_yaml.YamlDecode(a_fileLines);

            Assert.That(
                ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_recordOut, o_recordIn, o_yaml.UseProperties),
                Is.True,
            ...
            o_recordIn = (ForestNET.Tests.SQL.AllTypesRecord?)o_yaml.YamlDecode(a_fileLines);
        ...
        private static void YamlObject(string p_s_testDirectory, string p_s_fileNameSuffix)
        {
            ...
            ForestNET.Tests.SQL.AllTypesRecord? o_recordIn = (ForestNET.Tests.SQL.AllTypesRecord?)o_yaml.YamlDecode(s_fileSimpleClass);
        ...
        private static void YamlClass(string p_s_testDirectory, string p_s_yamlSchemaFileName, string p_s_fileNameSuffix)
        {
            ...
            string s_resourcesDirectory = Environment.CurrentDirectory + ForestNET.Lib.IO.File.DIR + "Resources" + ForestNET.Lib.IO.File.DIR;
            string s_yamlSchemaFile = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + p_s_yamlSchemaFileName;

            ForestNET.Lib.IO.YAML o_yaml = new(s_yamlSchemaFile, 4);
        ...
        private static void YamlArray(string p_s_testDirectory, string p_s_yamlSchemaFileName, string p_s_fileNameSuffix)
        {
            ...
            if (p_s_yamlSchemaFileName.Equals("TestYAMLSchemaSimpleClassArray.yaml"))
            {
                List<ForestNET.Tests.IO.Data.SimpleClass>? a_foo = [.. ((System.Collections.IEnumerable)(o_yaml.YamlDecode(s_fileSimpleClass) ?? new List<ForestNET.Tests.IO.Data.SimpleClass>())).Cast<ForestNET.Tests.IO.Data.SimpleClass>()];
                a_dataIn = a_foo;
            }
            else
            {
                o_collectionIn = (ForestNET.Tests.IO.Data.SimpleClassCollection?)o_yaml.YamlDecode(s_fileSimpleClass);
            ...
            {
                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_collectionOut, o_collectionIn, o_yaml.UseProperties),
                    Is.True,
            ...
            Assert.That(
                ForestNET.Lib.Helper.ObjectsEqualUsingReflections(a_dataOut, a_dataIn, o_yaml.UseProperties),
                Is.True,
            ...
            {
                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(a_dataOut[i], a_dataIn?[i], o_yaml.UseProperties, false, true),
                    Is.True,
        ...
        private static void YamlComplex(string p_s_testDirectory, bool p_b_classRoot, bool p_b_listRoot, bool p_b_classRootWithRef, bool p_b_listRootWithRef, string p_s_fileNameSuffix)
        {
            ...
            if (p_b_classRoot)
            {
                s_yamlSchemaFile = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + "TestYAMLSchemaClassRoot.yaml";
            }
            else if (p_b_listRoot)
            {
                s_yamlSchemaFile = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + "TestYAMLSchemaListRoot.yaml";
            }
            else if (p_b_classRootWithRef)
            {
                s_yamlSchemaFile = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + "TestYAMLSchemaClassRootWithRef.yaml";
            }
            else if (p_b_listRootWithRef)
            {
                s_yamlSchemaFile = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + "TestYAMLSchemaListRootWithRef.yaml";
            }
            ...
            if ((p_b_classRoot) || (p_b_classRootWithRef))
            {
                o_shipOrderCollectionIn = (ForestNET.Tests.IO.Data.ShipOrderCollection?)o_yaml.YamlDecode(s_file);
            ...
            {
                List<ForestNET.Tests.IO.Data.ShipOrder> a_foo = [.. ((System.Collections.IEnumerable)(o_yaml.YamlDecode(s_file) ?? new List<ForestNET.Tests.IO.Data.ShipOrder>())).Cast<ForestNET.Tests.IO.Data.ShipOrder>()];
            ...
            {
                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_shipOrderCollectionOut, o_shipOrderCollectionIn, o_yaml.UseProperties),
                    Is.True,
                    "output object inner class collection is not equal to input object inner class collection"
                );
            }
            ...
            Assert.That(
                ForestNET.Lib.Helper.ObjectsEqualUsingReflections(a_shipOrdersOut, a_shipOrdersIn, o_yaml.UseProperties),
                Is.True,
                "output object inner class array is not equal to input object inner class array"
            );
            ...
            if (a_shipOrdersIn != null)
            {
                ...
                {
                    Assert.That(
                        ForestNET.Lib.Helper.ObjectsEqualUsingReflections(a_shipOrdersOut[i], a_shipOrdersIn[i], o_yaml.UseProperties, false, true),
                        Is.True,
                        "output object inner class array element object is not equal to input object inner class array element object"
                    );
            ...
            {
                s_file = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + "TestYAMLPrimitiveArrayOneLine.yaml";
        ...
        private static void YamlMultipleUseOfOneSchemaObject(string p_s_testDirectory)
        {
            ...
            string s_resourcesDirectory = Environment.CurrentDirectory + ForestNET.Lib.IO.File.DIR + "Resources" + ForestNET.Lib.IO.File.DIR;
            string s_yamlSchemaFile = s_resourcesDirectory + "yaml" + ForestNET.Lib.IO.File.DIR + "TestYAMLSchemaSimpleClassObjectMultiReferences.yaml";
            ForestNET.Lib.IO.YAML o_yaml = new(s_yamlSchemaFile, 4)
            {
                UseProperties = true
            };
            ...
            o_yaml = new ForestNET.Lib.IO.YAML(s_yamlSchemaFile, 4)
            {
                UseProperties = true
            };

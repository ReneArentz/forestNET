    ...
    public class FixedLengthRecordUnitTest
    {
        ...
        public void TestFixedLengthRecord()
        {
            try
            {
                ...
                string s_resourcesFLRDirectory = Environment.CurrentDirectory + ForestNET.Lib.IO.File.DIR + "Resources" + ForestNET.Lib.IO.File.DIR + "flr" + ForestNET.Lib.IO.File.DIR;
                string s_testDirectory = s_currentDirectory + ForestNET.Lib.IO.File.DIR + "testFLR" + ForestNET.Lib.IO.File.DIR;
        ...
        private static void FLRReadWithGroupHeader(string p_s_flrFileName)
        {
            ...
            FixedLengthRecordFile o_flrFile = new(o_flrData, "^000.*$")
            {
                GroupHeader = new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_groupHeaderData, "^\\+H\\+.*$")
            };
            o_flrFile.ReadFile(p_s_flrFileName);
            ...
            o_flrFile = new(o_flrData, null, 320)
            {
                GroupHeader = new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_groupHeaderData, null, 106)
            };
            o_flrFile.ReadFile(p_s_flrFileName);
        ...
        private static void FLRReadWithGroupFooter(string p_s_flrFileName)
        {
            ...
            FixedLengthRecordFile o_flrFile = new(o_flrData, "^000.*$")
            {
                GroupFooter = new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_groupFooterData, "^\\+F\\+.*$")
            };
            o_flrFile.ReadFile(p_s_flrFileName);
            ...
            o_flrFile = new(o_flrData, null, 320)
            {
                GroupFooter = new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_groupFooterData, null, 81)
            };
            o_flrFile.ReadFile(p_s_flrFileName);
        ...
        private static void FLRReadEverything(string p_s_flrFileName)
        {
            ...
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrOtherData, "^100.*$"));
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrAnotherData, "^200.*$"));
            o_flrFile.ReadFile(p_s_flrFileName);
            ...
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrOtherData, null, 58));
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrAnotherData, null, 72));
            o_flrFile.ReadFile(p_s_flrFileName);
        ...
        private static void FLRReadEverythingWithSubtypes(string p_s_flrFileName)
        {
            ...
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrOtherData, "^100.*$"));
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrAnotherData, "^200.*$"));
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrDataWithSubtypes, "^300.*$"));
            o_flrFile.ReadFile(p_s_flrFileName);
            ...
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrOtherData, null, 58));
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrAnotherData, null, 72));
            o_flrFile.AddFLRType(new ForestNET.Lib.IO.FixedLengthRecordFile.FLRType(o_flrDataWithSubtypes, null, 217));
            o_flrFile.ReadFile(p_s_flrFileName);
        ...
        private static void CompareRecords(int p_i_record, FixedLengthRecordData o_record)
        {
            if (p_i_record == 0)
            {
                ...
                Assert.That(o_record.FieldLocalDateTime, Is.EqualTo(ForestNET.Lib.Helper.FromISO8601UTC("2011-01-01T01:04:08Z")), "values for field 'LocalDateTime' are not equal");
            ...
            else if (p_i_record == 1)
            {
                ...
                Assert.That(o_record.FieldLocalDateTime, Is.EqualTo(ForestNET.Lib.Helper.FromISO8601UTC("2022-02-02T03:08:16Z")), "values for field 'LocalDateTime' are not equal");
            ...
            else if (p_i_record == 2)
            {
                ...
                Assert.That(o_record.FieldLocalDateTime, Is.EqualTo(ForestNET.Lib.Helper.FromISO8601UTC("2033-03-03T05:16:32Z")), "values for field 'LocalDateTime' are not equal");
            ...
            else if (p_i_record == 3)
            {
                ...
                Assert.That(o_record.FieldLocalDateTime, Is.EqualTo(ForestNET.Lib.Helper.FromISO8601UTC("2044-04-04T07:32:04Z")), "values for field 'LocalDateTime' are not equal");
            ...
            else if (p_i_record == 4)
            {
                ...
                Assert.That(o_record.FieldLocalDateTime, Is.EqualTo(ForestNET.Lib.Helper.FromISO8601UTC("2055-05-05T09:04:08Z")), "values for field 'LocalDateTime' are not equal");
            ...
            else if (p_i_record == 5)
            {
                ...
                Assert.That(o_record.FieldLocalDateTime, Is.EqualTo(ForestNET.Lib.Helper.FromISO8601UTC("2066-06-06T11:08:16Z")), "values for field 'LocalDateTime' are not equal");
            ...
            else if (p_i_record == 7)
            {
                ...
                Assert.That(o_record.FieldLocalDateTime, Is.EqualTo(ForestNET.Lib.Helper.FromISO8601UTC("2077-07-07T13:16:32Z")), "values for field 'LocalDateTime' are not equal");
            ...
            else if (p_i_record == 8)
            {
                ...
                Assert.That(o_record.FieldLocalDateTime, Is.EqualTo(ForestNET.Lib.Helper.FromISO8601UTC("2088-08-08T15:32:04Z")), "values for field 'LocalDateTime' are not equal");
        ...
        private static void FLRWriteTests(string p_s_flrFileName, string p_s_contentCompareFileName, int p_i_mode)
        {
            ...
            /* compare file hashes */
            Assert.That(
                ForestNET.Lib.IO.File.HashFile(p_s_flrFileName, "SHA-512"),
                Is.EqualTo(ForestNET.Lib.IO.File.HashFile(p_s_contentCompareFileName, "SHA-512")),
                "flr file[" + p_s_flrFileName + "] has not the expected content"
            );
        }

        private static void CreateStackData(int p_i_mode, ForestNET.Lib.IO.FixedLengthRecordFile p_o_flrFile)
        {
            /*
            ...
            ForestNET.Lib.IO.FixedLengthRecordFile.FixedLengthRecordStack o_stack = ForestNET.Lib.IO.FixedLengthRecordFile.CreateNewStack();
            ...
            FixedLengthRecordData o_flr = new()
            {
                ...
                FieldLocalDateTime = ForestNET.Lib.Helper.FromISO8601UTC("2011-01-01T01:04:08Z"),
            ...
            o_flr = new()
            {
                ...
                FieldLocalDateTime = ForestNET.Lib.Helper.FromISO8601UTC("2022-02-02T03:08:16Z"),
            ...
            o_flr = new()
            {
                ...
                FieldLocalDateTime = ForestNET.Lib.Helper.FromISO8601UTC("2033-03-03T05:16:32Z"),
            ...
            if ((p_i_mode == 2) || (p_i_mode == 3) || (p_i_mode == 4) || (p_i_mode == 5))
            {
                ...
                o_stack = ForestNET.Lib.IO.FixedLengthRecordFile.CreateNewStack();
                i_recordNumber = 0;
            }
            ...
            o_flr = new()
            {
                ...
                FieldLocalDateTime = ForestNET.Lib.Helper.FromISO8601UTC("2044-04-04T07:32:04Z"),
            ...
            o_flr = new()
            {
                ...
                FieldLocalDateTime = ForestNET.Lib.Helper.FromISO8601UTC("2055-05-05T09:04:08Z"),
                FieldByteCol = (byte)8,
                FieldFloatCol = 4390.24f,
            ...
            o_flr = new()
            {
                ...
                FieldLocalDateTime = ForestNET.Lib.Helper.FromISO8601UTC("2066-06-06T11:08:16Z"),
                FieldByteCol = (byte)4,
            ...
            o_flr = new()
            {
                ...
                FieldLocalDateTime = ForestNET.Lib.Helper.FromISO8601UTC("2077-07-07T13:16:32Z"),
                FieldByteCol = (byte)2,
            ...
            o_flr = new()
            {
                ...
                FieldLocalDateTime = ForestNET.Lib.Helper.FromISO8601UTC("2088-08-08T15:32:04Z"),
                FieldByteCol = (byte)1,
        ...
        public void TestFixedLengthRecordStandardTransposeMethods()
        {
            try
            {
                ...
                Assert.That(
                    (string)(ForestNET.Lib.IO.StandardTransposeMethods.TransposeString("This is just a test This is just a test This is just a test This is just a test") ?? ""),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.TransposeString("This is just a test This is just a test This is just a test This is just a test", 35),
                ...
                Assert.That(
                    (bool)(ForestNET.Lib.IO.StandardTransposeMethods.TransposeBoolean("true") ?? ""),
                    Is.EqualTo(true),
                    "FixedLengthRecord StandardTransposeMethods TransposeBoolean(String) method does not return expected value"
                );

                Assert.That(
                    (bool)(ForestNET.Lib.IO.StandardTransposeMethods.TransposeBoolean("1") ?? ""),
                    Is.EqualTo(true),
                    "FixedLengthRecord StandardTransposeMethods TransposeBoolean(String) method does not return expected value"
                );

                Assert.That(
                    (bool)(ForestNET.Lib.IO.StandardTransposeMethods.TransposeBoolean("y") ?? ""),
                    Is.EqualTo(true),
                    "FixedLengthRecord StandardTransposeMethods TransposeBoolean(String) method does not return expected value"
                );

                Assert.That(
                    (bool)(ForestNET.Lib.IO.StandardTransposeMethods.TransposeBoolean("j") ?? ""),
                    Is.EqualTo(true),
                    "FixedLengthRecord StandardTransposeMethods TransposeBoolean(String) method does not return expected value"
                );

                Assert.That(
                    (bool)(ForestNET.Lib.IO.StandardTransposeMethods.TransposeBoolean("0") ?? ""),
                    Is.EqualTo(false),
                    "FixedLengthRecord StandardTransposeMethods TransposeBoolean(String) method does not return expected value"
                );

                Assert.That(
                    (bool)(ForestNET.Lib.IO.StandardTransposeMethods.TransposeBoolean("test") ?? ""),
                    Is.EqualTo(false),
                    "FixedLengthRecord StandardTransposeMethods TransposeBoolean(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.TransposeBoolean(true, 1),
                    Is.EqualTo("1"),
                    "FixedLengthRecord StandardTransposeMethods TransposeBoolean(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.TransposeBoolean(false, 1),
                    Is.EqualTo("0"),
                    "FixedLengthRecord StandardTransposeMethods TransposeBoolean(Object, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    (byte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeByte("000001") ?? 0),
                    Is.EqualTo((byte)1),
                    "FixedLengthRecord StandardTransposeMethods TransposeByte(String) method does not return expected value"
                );

                Assert.That(
                    (byte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeByte("0127") ?? 0),
                    Is.EqualTo((byte)127),
                    "FixedLengthRecord StandardTransposeMethods TransposeByte(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeByte((byte)1, 6),
                    Is.EqualTo("000001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeByte(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeByte((byte)127, 7),
                    Is.EqualTo("0000127"),
                    "FixedLengthRecord StandardTransposeMethods TransposeByte(Object, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByte("000001") ?? 0),
                    Is.EqualTo((sbyte)1),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByte(String) method does not return expected value"
                );

                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByte("0127") ?? 0),
                    Is.EqualTo((sbyte)127),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByte(String) method does not return expected value"
                );

                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByte("-00001") ?? 0),
                    Is.EqualTo((sbyte)-1),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByte(String) method does not return expected value"
                );

                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByte("+000127") ?? 0),
                    Is.EqualTo((sbyte)127),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByte(String) method does not return expected value"
                );

                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByte("-000112") ?? 0),
                    Is.EqualTo((sbyte)-112),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByte(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByte((sbyte)1, 6),
                    Is.EqualTo("000001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByte(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByte((sbyte)127, 4),
                    Is.EqualTo("0127"),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByte(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign("+000001") ?? 0),
                    Is.EqualTo((sbyte)1),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByteWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign("+0127") ?? 0),
                    Is.EqualTo((sbyte)127),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByteWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign("-00001") ?? 0),
                    Is.EqualTo((sbyte)-1),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByteWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign("+000127") ?? 0),
                    Is.EqualTo((sbyte)127),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByteWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (sbyte)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign("-000112") ?? 0),
                    Is.EqualTo((sbyte)-112),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByteWithSign(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign((sbyte)1, 6),
                    Is.EqualTo("+00001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign((sbyte)127, 4),
                    Is.EqualTo("+127"),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByteWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign((sbyte)-1, 5),
                    Is.EqualTo("-0001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByteWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign((sbyte)127, 6),
                    Is.EqualTo("+00127"),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByteWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeSignedByteWithSign((sbyte)-112, 7),
                    Is.EqualTo("-000112"),
                    "FixedLengthRecord StandardTransposeMethods TransposeSignedByteWithSign(Object, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    (short)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShort("000001") ?? 0),
                    Is.EqualTo((short)1),
                    "FixedLengthRecord StandardTransposeMethods TransposeShort(String) method does not return expected value"
                );

                Assert.That(
                    (short)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShort("032767") ?? 0),
                    Is.EqualTo((short)32767),
                    "FixedLengthRecord StandardTransposeMethods TransposeShort(String) method does not return expected value"
                );

                Assert.That(
                    (short)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShortWithSign("-00001") ?? 0),
                    Is.EqualTo((short)-1),
                    "FixedLengthRecord StandardTransposeMethods TransposeShortWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (short)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShortWithSign("+032767") ?? 0),
                    Is.EqualTo((short)32767),
                    "FixedLengthRecord StandardTransposeMethods TransposeShortWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (short)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShortWithSign("-00016348") ?? 0),
                    Is.EqualTo((short)-16348),
                    "FixedLengthRecord StandardTransposeMethods TransposeShortWithSign(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShort((short)1, 6),
                    Is.EqualTo("000001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeShort(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShort((short)32767, 7),
                    Is.EqualTo("0032767"),
                    "FixedLengthRecord StandardTransposeMethods TransposeShort(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShortWithSign((short)-1, 5),
                    Is.EqualTo("-0001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeShortWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShortWithSign((short)32767, 7),
                    Is.EqualTo("+032767"),
                    "FixedLengthRecord StandardTransposeMethods TransposeShortWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeShortWithSign((short)-16348, 9),
                    Is.EqualTo("-00016348"),
                    "FixedLengthRecord StandardTransposeMethods TransposeShortWithSign(Object, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    (int)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeInteger("000001") ?? 0),
                    Is.EqualTo(1),
                    "FixedLengthRecord StandardTransposeMethods TransposeInteger(String) method does not return expected value"
                );

                Assert.That(
                    (int)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeInteger("002147483647") ?? 0),
                    Is.EqualTo(2147483647),
                    "FixedLengthRecord StandardTransposeMethods TransposeInteger(String) method does not return expected value"
                );

                Assert.That(
                    (int)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeIntegerWithSign("-00001") ?? 0),
                    Is.EqualTo(-1),
                    "FixedLengthRecord StandardTransposeMethods TransposeIntegerWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (int)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeIntegerWithSign("+02147483647") ?? 0),
                    Is.EqualTo(2147483647),
                    "FixedLengthRecord StandardTransposeMethods TransposeIntegerWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (int)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeIntegerWithSign("-0001073741823") ?? 0),
                    Is.EqualTo(-1073741823),
                    "FixedLengthRecord StandardTransposeMethods TransposeIntegerWithSign(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeInteger(1, 6),
                    Is.EqualTo("000001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeInteger(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeInteger(2147483647, 12),
                    Is.EqualTo("002147483647"),
                    "FixedLengthRecord StandardTransposeMethods TransposeInteger(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeIntegerWithSign(-1, 5),
                    Is.EqualTo("-0001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeIntegerWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeIntegerWithSign(2147483647, 12),
                    Is.EqualTo("+02147483647"),
                    "FixedLengthRecord StandardTransposeMethods TransposeIntegerWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeIntegerWithSign(-1073741823, 14),
                ...
                Assert.That(
                    (long)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLong("000001") ?? 0),
                    Is.EqualTo(1L),
                    "FixedLengthRecord StandardTransposeMethods TransposeLong(String) method does not return expected value"
                );

                Assert.That(
                    (long)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLong("09223372036854775807") ?? 0),
                    Is.EqualTo(9223372036854775807L),
                    "FixedLengthRecord StandardTransposeMethods TransposeLong(String) method does not return expected value"
                );

                Assert.That(
                    (long)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLongWithSign("-00001") ?? 0),
                    Is.EqualTo(-1L),
                    "FixedLengthRecord StandardTransposeMethods TransposeLongWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (long)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLongWithSign("+009223372036854775807") ?? 0),
                    Is.EqualTo(9223372036854775807L),
                    "FixedLengthRecord StandardTransposeMethods TransposeLongWithSign(String) method does not return expected value"
                );

                Assert.That(
                    (long)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLongWithSign("-0004611686018427387903") ?? 0),
                    Is.EqualTo(-4611686018427387903L),
                    "FixedLengthRecord StandardTransposeMethods TransposeLongWithSign(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLong(1L, 6),
                    Is.EqualTo("000001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeLong(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLong(9223372036854775807L, 22),
                    Is.EqualTo("0009223372036854775807"),
                    "FixedLengthRecord StandardTransposeMethods TransposeLong(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLongWithSign(-1L, 5),
                    Is.EqualTo("-0001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeLongWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLongWithSign(9223372036854775807L, 21),
                    Is.EqualTo("+09223372036854775807"),
                    "FixedLengthRecord StandardTransposeMethods TransposeLongWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeLongWithSign(-4611686018427387903L, 23),
                ...
                Assert.That(
                    (ushort)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShort("000001") ?? 0),
                    Is.EqualTo((ushort)1),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedShort(String) method does not return expected value"
                );

                Assert.That(
                    (ushort)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShort("065535") ?? 0),
                    Is.EqualTo((ushort)65535),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedShort(String) method does not return expected value"
                );

                Assert.Throws<InvalidCastException>(() => ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShortWithSign("-00001"));

                Assert.That(
                    (ushort)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShortWithSign("+065535") ?? 0),
                    Is.EqualTo((ushort)65535),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedShortWithSign(String) method does not return expected value"
                );

                Assert.Throws<InvalidCastException>(() => ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShortWithSign("-00016348"));

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShort((ushort)1, 6),
                    Is.EqualTo("000001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedShort(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShort((ushort)32767, 7),
                    Is.EqualTo("0032767"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedShort(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShortWithSign((ushort)1, 5),
                    Is.EqualTo("+0001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShortWithSign((ushort)32767, 7),
                    Is.EqualTo("+032767"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedShortWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedShortWithSign((ushort)65535, 9),
                    Is.EqualTo("+00065535"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedShortWithSign(Object, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    (uint)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedInteger("000001") ?? 0),
                    Is.EqualTo((uint)1),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedInteger(String) method does not return expected value"
                );

                Assert.That(
                    (uint)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedInteger("004294967295") ?? 0),
                    Is.EqualTo((uint)4294967295),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedInteger(String) method does not return expected value"
                );

                Assert.Throws<InvalidCastException>(() => ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedIntegerWithSign("-00001"));

                Assert.That(
                    (uint)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedIntegerWithSign("+04294967295") ?? 0),
                    Is.EqualTo((uint)4294967295),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedIntegerWithSign(String) method does not return expected value"
                );

                Assert.Throws<InvalidCastException>(() => ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedIntegerWithSign("-0001073741823"));

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedInteger((uint)1, 6),
                    Is.EqualTo("000001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedInteger(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedInteger((uint)4294967295, 12),
                    Is.EqualTo("004294967295"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedInteger(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedIntegerWithSign((uint)1, 5),
                    Is.EqualTo("+0001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedIntegerWithSign((uint)4294967295, 12),
                    Is.EqualTo("+04294967295"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedIntegerWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedIntegerWithSign((uint)1073741823, 14),
                    Is.EqualTo("+0001073741823"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedIntegerWithSign(Object, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    (ulong)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLong("000001") ?? 0),
                    Is.EqualTo((ulong)1L),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedLong(String) method does not return expected value"
                );

                Assert.That(
                    (ulong)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLong("018446744073709551615") ?? 0),
                    Is.EqualTo((ulong)18446744073709551615L),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedLong(String) method does not return expected value"
                );

                Assert.Throws<InvalidCastException>(() => ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLongWithSign("-00001"));

                Assert.That(
                    (ulong)(ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLongWithSign("+0018446744073709551615") ?? 0),
                    Is.EqualTo((ulong)18446744073709551615L),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedLongWithSign(String) method does not return expected value"
                );

                Assert.Throws<InvalidCastException>(() => ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLongWithSign("-0004611686018427387903"));

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLong((ulong)1L, 6),
                    Is.EqualTo("000001"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedLong(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLong((ulong)18446744073709551615L, 24),
                    Is.EqualTo("000018446744073709551615"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedLong(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLongWithSign((ulong)1L, 5),
                    Is.EqualTo("+0001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLongWithSign((ulong)18446744073709551615L, 22),
                    Is.EqualTo("+018446744073709551615"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedLongWithSign(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.Numbers.TransposeUnsignedLongWithSign((ulong)4611686018427387903L, 23),
                    Is.EqualTo("+0004611686018427387903"),
                    "FixedLengthRecord StandardTransposeMethods TransposeUnsignedLongWithSign(Object, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ISO8601("2020-03-14T05:02:03Z") ?? DateTime.MinValue),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ISO8601("2020-03-14 05:02:03Z") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_ISO8601(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ISO8601_NoSeparator(o_dateTime, 20),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ISO8601(o_dateTime, 20),
                    Is.EqualTo("2020-03-14T05:02:03Z"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_ISO8601(Object, Integer) method does not return expected value"
                );

                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_RFC1123("Sat, 14 Mar 2020 05:02:03 GMT") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_RFC1123(o_dateTime, 29),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmddhhiiss("20110101020408") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_yyyymmddhhiiss(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmddhhiiss(o_dateTime, 14),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmddhhiiss_ISO("2011-01-01 02:04:08") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmddhhiiss_ISO(o_dateTime, 19),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ddmmyyyyhhiiss_Dot("01.10.2011 02:04:08") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ddmmyyyyhhiiss_Dot(o_dateTime, 19),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ddmmyyyyhhiiss_Slash("01/10/2011 02:04:08") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ddmmyyyyhhiiss_Slash(o_dateTime, 19),
                    Is.EqualTo("01/10/2011 02:04:08"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmddhhiiss_Dot("2011.10.01 02:04:08") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmddhhiiss_Dot(o_dateTime, 19),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmddhhiiss_Slash("2011/10/01 02:04:08") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmddhhiiss_Slash(o_dateTime, 19),
                    Is.EqualTo("2011/10/01 02:04:08"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_mmddyyyyhhiiss_Dot("10.01.2011 02:04:08") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_mmddyyyyhhiiss_Dot(o_dateTime, 19),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_mmddyyyyhhiiss_Slash("10/01/2011 02:04:08") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_mmddyyyyhhiiss_Slash(o_dateTime, 19),
                    Is.EqualTo("10/01/2011 02:04:08"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmdd("20110101") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_yyyymmdd(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmdd(o_dateTime, 8),
                    Is.EqualTo("20110101"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmdd_ISO("2011-01-01") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_yyyymmdd(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmdd_ISO(o_dateTime, 10),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ddmmyyyy_Dot("01.10.2011") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_ddmmyyyy_Dot(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ddmmyyyy_Dot(o_dateTime, 10),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ddmmyyyy_Slash("01/10/2011") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_ddmmyyyy_Slash(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_ddmmyyyy_Slash(o_dateTime, 10),
                    Is.EqualTo("01/10/2011"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmdd_Dot("2011.10.01") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_yyyymmdd_Dot(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmdd_Dot(o_dateTime, 10),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmdd_Slash("2011/10/01") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_yyyymmdd_Slash(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_yyyymmdd_Slash(o_dateTime, 10),
                    Is.EqualTo("2011/10/01"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_mmddyyyy_Dot("10.01.2011") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_mmddyyyy_Dot(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_mmddyyyy_Dot(o_dateTime, 10),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_mmddyyyy_Slash("10/01/2011") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_mmddyyyy_Slash(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_mmddyyyy_Slash(o_dateTime, 10),
                    Is.EqualTo("10/01/2011"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_hhiiss("020304") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_hhiiss(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_hhiiss(o_dateTime, 6),
                    Is.EqualTo("020304"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_hhii("0203") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_hhii(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_hhii(o_dateTime, 4),
                    Is.EqualTo("0203"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_hhiiss_Colon("02:03:04") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_hhiiss_Colon(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_hhiiss_Colon(o_dateTime, 8),
                    Is.EqualTo("02:03:04"),
                ...
                Assert.That(
                    (DateTime)(ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_hhii_Colon("02:03") ?? DateTime.MinValue),
                    Is.EqualTo(o_dateTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeDateTime_hhii_Colon(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.DateTime.TransposeDateTime_hhii_Colon(o_dateTime, 5),
                    Is.EqualTo("02:03"),
                ...
                Assert.That(
                    (TimeSpan)(ForestNET.Lib.IO.StandardTransposeMethods.TimeSpan.TransposeTimeSpan_hhiiss("020304") ?? TimeSpan.MinValue),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.TimeSpan.TransposeTimeSpan_hhiiss(o_localTime, 6),
                    Is.EqualTo("020304"),
                ...
                Assert.That(
                    (TimeSpan)(ForestNET.Lib.IO.StandardTransposeMethods.TimeSpan.TransposeTimeSpan_hhii("0203") ?? TimeSpan.MinValue),
                    Is.EqualTo(o_localTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeTimeSpan_hhii(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.TimeSpan.TransposeTimeSpan_hhii(o_localTime, 4),
                    Is.EqualTo("0203"),
                ...
                Assert.That(
                    (TimeSpan)(ForestNET.Lib.IO.StandardTransposeMethods.TimeSpan.TransposeTimeSpan_hhiiss_Colon("02:03:04") ?? TimeSpan.MinValue),
                    Is.EqualTo(o_localTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeTimeSpan_hhiiss_Colon(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.TimeSpan.TransposeTimeSpan_hhiiss_Colon(o_localTime, 8),
                    Is.EqualTo("02:03:04"),
                ...
                Assert.That(
                    (TimeSpan)(ForestNET.Lib.IO.StandardTransposeMethods.TimeSpan.TransposeTimeSpan_hhii_Colon("02:03") ?? TimeSpan.MinValue),
                    Is.EqualTo(o_localTime),
                    "FixedLengthRecord StandardTransposeMethods TransposeTimeSpan_hhii_Colon(String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.TimeSpan.TransposeTimeSpan_hhii_Colon(o_localTime, 5),
                    Is.EqualTo("02:03"),
                ...
                Assert.That(
                    (float)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat("000001", 0) ?? 0f),
                    Is.EqualTo(1f),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(String) method does not return expected value"
                );

                Assert.That(
                    (float)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat("-00001", 0) ?? 0f),
                    Is.EqualTo(-1f),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(String) method does not return expected value"
                );

                Assert.That(
                    (float)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat("00000000000000000000000", 13) ?? 0f),
                    Is.EqualTo(0.0f),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(String) method does not return expected value"
                );
                ...
                Assert.That(
                    (float)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat("002147483647", 0) ?? 0f),
                    Is.EqualTo(2147483647f),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(String) method does not return expected value"
                );

                Assert.That(
                    (float)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat("00214748.3647", 0) ?? 0f),
                ...
                Assert.That(
                    (float)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat("-0002147,483647", 0) ?? 0f),
                    Is.EqualTo(-2147.483647f),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(String) method does not return expected value"
                );

                Assert.That(
                    (float)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat("002147483647", 8) ?? 0f),
                    Is.EqualTo(214748.3647f),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(String, Integer) method does not return expected value"
                );

                Assert.That(
                    (float)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat("+002147483647", 9) ?? 0f),
                    Is.EqualTo(214748.3647f),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(String, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat(1f, 6, 0, null, null),
                    Is.EqualTo("000001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat(214748f, 8, 0, null, null),
                    Is.EqualTo("00214748"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(Object, Integer, Integer, String, String) method does not return expected value"
                );
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat(214748.1230101f, 8, 2),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat(-214748.1230101f, 8, 2, ",", null),
                    Is.EqualTo("00214748,12"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat(-214748.1230101f, 8, 2, null, null),
                    Is.EqualTo("0021474812"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat(214748.1230101f, 8, 4, ",", null),
                    Is.EqualTo("00214748,1250"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat(-214748.1230101f, 8, 4, null, null),
                    Is.EqualTo("002147481250"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign(1f, 6, 0, null, null),
                    Is.EqualTo("+000001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign(214748f, 8, 0, null, null),
                    Is.EqualTo("+00214748"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloatWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );
                ...
                /* use your system group and decimal separator here, for GER it is '.' and ',' */
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign(214748.1230101f, 8, 2),
                    Is.EqualTo("+00.214.748,12"), // Is.EqualTo("+00,214,748.12"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign(-214748.1230101f, 8, 2, ",", null),
                    Is.EqualTo("-00214748,12"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloatWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign(214748.1230101f, 8, 2, null, null),
                    Is.EqualTo("+0021474812"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloatWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign(-214748.1230101f, 8, 4, ",", null),
                    Is.EqualTo("-00214748,1250"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloatWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign(-214748.1230101f, 8, 4, null, null),
                    Is.EqualTo("-002147481250"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloatWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat((0f), 5, 8, null, null),
                    Is.EqualTo("0000000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign((0f), 5, 8, null, null),
                    Is.EqualTo("+0000000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloatWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat((0f), 5, 8, ",", null),
                    Is.EqualTo("00000,00000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign((0f), 5, 8, ",", null),
                    Is.EqualTo("+00000,00000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloatWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloat((0f), 5, 8, ",", "."),
                    Is.EqualTo("00.000,00000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloat(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeFloatWithSign((0f), 5, 8, ",", "."),
                    Is.EqualTo("+00.000,00000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeFloatWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );
                ...
                Assert.That(
                    (double)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble("000001", 0) ?? 0d),
                    Is.EqualTo(1d),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(String) method does not return expected value"
                );

                Assert.That(
                    (double)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble("-00001", 0) ?? 0d),
                    Is.EqualTo(-1d),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(String) method does not return expected value"
                );

                Assert.That(
                    (double)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble("00000000000000000000000", 13) ?? 0d),
                    Is.EqualTo(0.0d),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(String) method does not return expected value"
                );
                ...
                Assert.That(
                    (double)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble("002147483647", 0) ?? 0d),
                    Is.EqualTo(2147483647d),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(String) method does not return expected value"
                );

                Assert.That(
                    (double)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble("00214748.3647", 0) ?? 0d),
                ...
                Assert.That(
                    (double)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble("-0002147,483647", 0) ?? 0d),
                    Is.EqualTo(-2147.483647d),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(String) method does not return expected value"
                );

                Assert.That(
                    (double)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble("002147483647", 8) ?? 0d),
                    Is.EqualTo(214748.3647d),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(String, Integer) method does not return expected value"
                );

                Assert.That(
                    (double)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble("+002147483647", 9) ?? 0d),
                    Is.EqualTo(214748.3647d),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(String, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble(1d, 6, 0, null, null),
                    Is.EqualTo("000001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble(214748d, 8, 0, null, null),
                    Is.EqualTo("00214748"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(Object, Integer, Integer, String, String) method does not return expected value"
                );
                ...
                /* use your system group and decimal separator here, for GER it is '.' and ',' */
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble(214748.1230101d, 8, 2),
                    Is.EqualTo("00.214.748,12"), // Is.EqualTo("00,214,748.12"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble(-214748.12301019812d, 8, 4, ",", null),
                    Is.EqualTo("00214748,1230"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble(214748.12301019812d, 8, 4, null, null),
                    Is.EqualTo("002147481230"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble(-214748.12301019812d, 8, 10, ",", null),
                    Is.EqualTo("00214748,1230101980"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble(-214748.12301019812d, 8, 10, null, null),
                    Is.EqualTo("002147481230101980"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign(1d, 6, 0, null, null),
                    Is.EqualTo("+000001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign(214748d, 8, 0, null, null),
                    Is.EqualTo("+00214748"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDoubleWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );
                ...
                /* use your system group and decimal separator here, for GER it is '.' and ',' */
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign(214748.1230101d, 8, 2),
                    Is.EqualTo("+00.214.748,12"), // Is.EqualTo("+00,214,748.12"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign(-214748.12301019812d, 8, 4, ",", null),
                    Is.EqualTo("-00214748,1230"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDoubleWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign(214748.12301019812d, 8, 4, null, null),
                    Is.EqualTo("+002147481230"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDoubleWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign(-214748.12301019812d, 8, 10, ",", null),
                    Is.EqualTo("-00214748,1230101980"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDoubleWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign(-214748.12301019812d, 8, 10, null, null),
                    Is.EqualTo("-002147481230101980"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDoubleWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble((0d), 6, 9, null, null),
                    Is.EqualTo("000000000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign((0d), 6, 9, null, null),
                    Is.EqualTo("+000000000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDoubleWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble((0d), 6, 9, ",", null),
                    Is.EqualTo("000000,000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign((0d), 6, 9, ",", null),
                    Is.EqualTo("+000000,000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDoubleWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDouble((0d), 6, 9, ",", "."),
                    Is.EqualTo("000.000,000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDouble(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDoubleWithSign((0d), 6, 9, ",", "."),
                    Is.EqualTo("+000.000,000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDoubleWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );
                ...
                Assert.That(
                    (decimal)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal("000001", 0) ?? 0m),
                    Is.EqualTo(1m),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(String) method does not return expected value"
                );

                Assert.That(
                    (decimal)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal("-00001", 0) ?? 0m),
                    Is.EqualTo(-1m),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(String) method does not return expected value"
                );

                Assert.That(
                    (decimal)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal("00000000000000000000000", 13) ?? 0m),
                    Is.EqualTo(0.0m),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(String) method does not return expected value"
                );
                ...
                Assert.That(
                    (decimal)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal("002147483647", 0) ?? 0m),
                    Is.EqualTo(2147483647m),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(String) method does not return expected value"
                );

                Assert.That(
                    (decimal)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal("00214748.3647", 0) ?? 0m),
                ...
                Assert.That(
                    (decimal)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal("-0002147,483647", 0) ?? 0m),
                    Is.EqualTo(-2147.483647m),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(String) method does not return expected value"
                );

                Assert.That(
                    (decimal)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal("002147483647", 8) ?? 0m),
                    Is.EqualTo(214748.3647m),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(String, Integer) method does not return expected value"
                );

                Assert.That(
                    (decimal)(ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal("+002147483647", 9) ?? 0m),
                    Is.EqualTo(214748.3647m),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(String, Integer) method does not return expected value"
                );
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((1m), 6, 0, null, null),
                    Is.EqualTo("000001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((214748m), 8, 0, null, null),
                    Is.EqualTo("00214748"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(Object, Integer, Integer, String, String) method does not return expected value"
                );
                ...
                /* use your system group and decimal separator here, for GER it is '.' and ',' */
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((214748.1230101m), 8, 2),
                    Is.EqualTo("00.214.748,12"), // Is.EqualTo("00,214,748.12"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((-214748.12301019812m), 8, 4, ",", null),
                    Is.EqualTo("00214748,1230"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((214748.12301019812m), 8, 4, null, null),
                    Is.EqualTo("002147481230"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((-214748.12301019812001m), 8, 11, ",", null),
                    Is.EqualTo("00214748,12301019812"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((-214748.12301019812001m), 8, 11, null, null),
                    Is.EqualTo("0021474812301019812"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((1m), 6, 0, null, null),
                    Is.EqualTo("+000001"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((214748m), 8, 0, null, null),
                    Is.EqualTo("+00214748"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimalWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );
                ...
                /* use your system group and decimal separator here, for GER it is '.' and ',' */
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((214748.1230101m), 8, 2),
                    Is.EqualTo("+00.214.748,12"), // Is.EqualTo("+00,214,748.12"),
                ...
                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((-214748.12301019812m), 8, 4, ",", null),
                    Is.EqualTo("-00214748,1230"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimalWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((214748.12301019812m), 8, 4, null, null),
                    Is.EqualTo("+002147481230"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimalWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((-214748.12301019812009m), 8, 11, ",", null),
                    Is.EqualTo("-00214748,12301019812"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimalWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((-214748.12301019812009m), 8, 11, null, null),
                    Is.EqualTo("-0021474812301019812"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimalWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((0m), 8, 11, null, null),
                    Is.EqualTo("0000000000000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((0m), 8, 11, null, null),
                    Is.EqualTo("+0000000000000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimalWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((0m), 8, 11, ",", null),
                    Is.EqualTo("00000000,00000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((0m), 8, 11, ",", null),
                    Is.EqualTo("+00000000,00000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimalWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimal((0m), 8, 11, ",", "."),
                    Is.EqualTo("00.000.000,00000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimal(Object, Integer, Integer, String, String) method does not return expected value"
                );

                Assert.That(
                    ForestNET.Lib.IO.StandardTransposeMethods.FloatingPointNumbers.TransposeDecimalWithSign((0m), 8, 11, ",", "."),
                    Is.EqualTo("+00.000.000,00000000000"),
                    "FixedLengthRecord StandardTransposeMethods TransposeDecimalWithSign(Object, Integer, Integer, String, String) method does not return expected value"
                );
            }

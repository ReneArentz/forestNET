...
namespace ForestNET.Tests.Core
{
    public class HelperUnitTest
    {
        ...
        public void TestHelper()
        {
            ...
            Assert.That(
                ForestNET.Lib.Helper.IsIpv4MulticastAddress("225.4.228.87"),
                Is.True,
                "'225.4.228.87' is not an ipv4 multicast address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv4MulticastAddress("225.4.228.87/16"),
                Is.False,
                "'225.4.228.87/16' is not an ipv4 multicast address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv4MulticastAddress("192.4.228.87"),
                Is.False,
                "'192.4.228.87' is not an ipv4 multicast address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv4MulticastAddress("240.4.228.87"),
                Is.False,
                "'240.4.228.87' is not an ipv4 multicast address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv4MulticastAddress("239.4.228.87"),
                Is.True,
                "'239.4.228.87' is not an ipv4 multicast address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv6Address("2001:0db8:85a3:08d3:1319:8a2e:0370:7347"),
                Is.True,
                "'2001:0db8:85a3:08d3:1319:8a2e:0370:7347' is not an ipv6 address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv6Address("fe80::ca32:231b:f27e:b696"),
                Is.True,
                "'fe80::ca32:231b:f27e:b696' is not an ipv6 address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv6Address("FE80:CD00:0000:0CDE:1257:0000:211E:729C"),
                Is.True,
                "'FE80:CD00:0000:0CDE:1257:0000:211E:729C' is not an ipv6 address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv6Address("fe80::ca32:231b:f27z:b696"),
                Is.False,
                "'fe80::ca32:231b:f27z:b696' is an ipv6 address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv6MulticastAddress("FF05::342"),
                Is.True,
                "'FF05::342' is not an ipv6 multicast address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv6MulticastAddress("FF05:0:0:0:0:0:0:342"),
                Is.True,
                "'FF05:0:0:0:0:0:0:342' is not an ipv6 multicast address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv6MulticastAddress("ff02::2"),
                Is.True,
                "'ff02::2' is not an ipv6 multicast address"
            );

            Assert.That(
                ForestNET.Lib.Helper.IsIpv6MulticastAddress("FE80:CD00:0000:0CDE:1257:0000:211E:729C"),
                Is.False,
            ...
            try
            {
                ...
                /*
                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOne, o_compareTwo, false),
                    Is.True,
                    "o_compareOne[" + o_compareOne + "] is not equal to o_compareTwo[" + o_compareTwo + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOneProp, o_compareTwoProp, true),
                    Is.True,
                    "o_compareOneProp[" + o_compareOneProp + "] is not equal to o_compareTwoProp[" + o_compareTwoProp + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOne, o_compareTwo, false, false, true),
                    Is.True,
                    "o_compareOne[" + o_compareOne + "] is not equal to o_compareTwo[" + o_compareTwo + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOneProp, o_compareTwoProp, true, false, true),
                    Is.True,
                    "o_compareOneProp[" + o_compareOneProp + "] is not equal to o_compareTwoProp[" + o_compareTwoProp + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOne, o_compareThree, false),
                    Is.False,
                    "o_compareOne[" + o_compareOne + "] is equal to o_compareThree[" + o_compareThree + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOneProp, o_compareThreeProp, true),
                    Is.False,
                    "o_compareOneProp[" + o_compareOneProp + "] is equal to o_compareThreeProp[" + o_compareThreeProp + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOne, o_compareThree, false, false, true),
                    Is.False,
                    "o_compareOne[" + o_compareOne + "] is equal to o_compareThree[" + o_compareThree + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOneProp, o_compareThreeProp, true, false, true),
                    Is.False,
                    "o_compareOneProp[" + o_compareOneProp + "] is equal to o_compareThreeProp[" + o_compareThreeProp + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOne, o_compareFour, false),
                    Is.True,
                    "o_compareOne[" + o_compareOne + "] is not equal to o_compareFour[" + o_compareFour + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOneProp, o_compareFourProp, true),
                    Is.True,
                    "o_compareOneProp[" + o_compareOneProp + "] is not equal to o_compareFourProp[" + o_compareFourProp + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOne, o_compareFour, false, false, true),
                    Is.False,
                    "o_compareOne[" + o_compareOne + "] is equal to o_compareFour[" + o_compareFour + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_compareOneProp, o_compareFourProp, true, false, true),
                    Is.False,
                    "o_compareOneProp[" + o_compareOneProp + "] is equal to o_compareFourProp[" + o_compareFourProp + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_listOne, o_listTwo, false),
                    Is.True,
                    "o_listOne[" + o_listOne + "] is not equal to o_listTwo[" + o_listTwo + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_listOneProp, o_listTwoProp, true),
                    Is.True,
                    "o_listOneProp[" + o_listOneProp + "] is not equal to o_listTwoProp[" + o_listTwoProp + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_listOne, o_listTwo, false, false, true),
                    Is.True,
                    "o_listOne[" + o_listOne + "] is not equal to o_listTwo[" + o_listTwo + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_listOneProp, o_listTwoProp, true, false, true),
                    Is.True,
                    "o_listOneProp[" + o_listOneProp + "] is not equal to o_listTwoProp[" + o_listTwoProp + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_listOne, o_listThree, false),
                    Is.False,
                    "o_listOne[" + o_listOne + "] is equal to o_listThree[" + o_listThree + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_listOneProp, o_listThreeProp, true),
                    Is.False,
                    "o_listOneProp[" + o_listOneProp + "] is equal to o_listThreeProp[" + o_listThreeProp + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_listOne, o_listThree, false, false, true),
                    Is.False,
                    "o_listOne[" + o_listOne + "] is equal to o_listThree[" + o_listThree + "]"
                );

                Assert.That(
                    ForestNET.Lib.Helper.ObjectsEqualUsingReflections(o_listOneProp, o_listThreeProp, true, false, true),
                    Is.False,
                    "o_listOneProp[" + o_listOneProp + "] is equal to o_listThreeProp[" + o_listThreeProp + "]"
                );*/
            }
    ...
    class CompareObject
    {
        ...
        {
            return this.ValueStr + "|" + this.ValueInt + "|" + this.ValueDateTime + "|" + String.Join(",", this.ValueLongArray) + "|" + ForestNET.Lib.Helper.JoinList<short>(this.ValueListShorts, ',') + "|" + this.ValueSubObject;
        }
    }

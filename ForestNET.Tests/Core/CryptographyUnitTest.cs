        ...
        public void TestCryptography()
        {
            try
            {
                ...
                foreach (string s_message in a_messages)
                {
                    ...
                    byte[] a_encrypted = ForestNET.Lib.Cryptography.Encrypt_AES_GCM(System.Text.Encoding.UTF8.GetBytes(s_message), s_commonSecretPassphrase, ForestNET.Lib.Cryptography.KEY128BIT);
                    byte[] a_decrypted = ForestNET.Lib.Cryptography.Decrypt_AES_GCM(a_encrypted, s_commonSecretPassphrase, ForestNET.Lib.Cryptography.KEY128BIT);
                    ...
                    a_encrypted = ForestNET.Lib.Cryptography.Encrypt_AES_GCM(System.Text.Encoding.UTF8.GetBytes(s_message), s_commonSecretPassphrase, ForestNET.Lib.Cryptography.KEY256BIT);
                    a_decrypted = ForestNET.Lib.Cryptography.Decrypt_AES_GCM(a_encrypted, s_commonSecretPassphrase);
                ...
                ForestNET.Lib.Cryptography o_cryptography128 = new(s_commonSecretPassphrase, ForestNET.Lib.Cryptography.KEY128BIT);
                ...
                ForestNET.Lib.Cryptography o_cryptography256 = new(s_commonSecretPassphrase, ForestNET.Lib.Cryptography.KEY256BIT);

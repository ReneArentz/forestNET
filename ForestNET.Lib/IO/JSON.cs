namespace ForestNET.Lib.IO
{
    ...
    public class JSON
    {
        ...
        public JSON(List<string> p_a_jsonSchemaLines)
        {
            ...
            ForestNET.Lib.Global.ILogConfig("json schema file lines validated");

            /* parse json */
            this.ParseJSON(s_json);

            ForestNET.Lib.Global.ILogConfig("json schema parsed");
        ...
        public JSON(string p_s_file)
        {
            ...
            ForestNET.Lib.Global.ILogConfig("json schema file validated");
        ...
        private void SetSchema(bool p_b_rootIsUnparsedSchema)
        {
            ...
            {
                if (ForestNET.Lib.Global.IsILevel((byte)ForestNET.Lib.Log.Level.MASS)) ForestNET.Lib.Global.ILogMass("Unparsed JSON-Schema: " + this.s_lineBreak + this.Root);
                ...
                ForestNET.Lib.Global.ILogConfig("json schema elements parsed");
            ...
            if (ForestNET.Lib.Global.IsILevel((byte)ForestNET.Lib.Log.Level.MASS)) ForestNET.Lib.Global.ILogMass("Parsed JSON-Schema: " + this.s_lineBreak + this.Root);

            this.o_schema = this.Root;

            ForestNET.Lib.Global.ILogConfig("set json root element as schema element");
        }
        ...
        private static JSONValueType GetJSONValueType(string? p_s_jsonValue)
        {
            ...
            /* get json value type */
            if ((p_s_jsonValue == null) || (ForestNET.Lib.Helper.IsStringEmpty(p_s_jsonValue)))
            {
        ...
        private void ParseJSON(string p_s_json)
        {
            ...
            while (p_s_json[i] != '}')
            {
                ...
                ForestNET.Lib.Global.ILogFiner(PrintIndentation() + s_jsonLine);
                ...
                {
                    ForestNET.Lib.Global.ILogFiner(PrintIndentation() + "new ArrayObject()");
                ...
                else
                {
                    ...
                    {
                        ForestNET.Lib.Global.ILogFiner(PrintIndentation() + s_jsonProperty + " = (" + e_jsonValueType + ")");
                    ...
                    {
                        ForestNET.Lib.Global.ILogFiner(PrintIndentation() + s_jsonProperty + " = " + s_jsonValue + " (" + e_jsonValueType + ")");
        ...
        private void ParseJSONSchema(JSONElement p_o_jsonSchemaElement)
        {
            if (p_o_jsonSchemaElement.Children.Count > 0)
            {
                ...
                foreach (JSONElement o_jsonChild in p_o_jsonSchemaElement.Children)
                {
                    ...
                    /* determine json value type */
                    if (ForestNET.Lib.Helper.IsStringEmpty(o_jsonChild.Value))
                    {
                        e_jsonValueType = JSONValueType.Object;
                    }
                    else
                    ...
                    ForestNET.Lib.Global.ILogFiner(PrintIndentation() + o_jsonChild.Name + "(" + e_jsonValueType + ") of " + p_o_jsonSchemaElement.Name);
                    ...
                    if (o_jsonChild.Level == 0)
                    {
                        ...
                        else if ((o_jsonChild.Name.ToLower().Equals("definitions")) || (o_jsonChild.Name.ToLower().Equals("properties")))
                        {
                            ...
                            {
                                ForestNET.Lib.Global.ILogFiner(PrintIndentation() + "save current element(" + this.o_currentElement?.Name + ") in temporary variable");

                                /* save current element in temporary variable */
                                JSONElement? o_oldCurrentElement = this.o_currentElement;

                                ForestNET.Lib.Global.ILogFiner(PrintIndentation() + "start recursion for: " + o_jsonChild.Name + " = (" + e_jsonValueType + ") for " + this.o_currentElement?.Name);
                                ...
                                ForestNET.Lib.Global.ILogFiner(PrintIndentation() + "end recursion for " + this.o_currentElement?.Name + ": " + o_jsonChild.Name + " = (" + e_jsonValueType + ")");

                                ForestNET.Lib.Global.ILogFiner(PrintIndentation() + "reset current element(" + this.o_currentElement?.Name + ") from temporary variable(" + o_oldCurrentElement?.Name + ")");
                    ...
                    if (e_jsonValueType == JSONValueType.Object)
                    {
                        ...
                        if (o_jsonChild.Name.ToLower().Equals("items"))
                        {
                            ...
                            if (o_jsonChild.Children.Count == 1)
                            {
                                ...
                                if (!ForestNET.Lib.Helper.IsStringEmpty(o_itemChild.Value))
                                {
                                    /* remove surrounded double quotes from value */
                                    ...
                                    if ((o_itemChild.Name.ToLower().Equals("$ref")) && (s_itemValue != null) && (s_itemValue.StartsWith("#")))
                                    {
                                        ...
                                        if (this.a_definitions != null)
                                        {
                                            foreach (JSONElement o_jsonDefinition in this.a_definitions.Children)
                                            {
                                                ...
                                                {
                                                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "setReference for (" + this.o_currentElement?.Name + ") with reference=" + s_referenceName);
                        ...
                        if (!b_skip)
                        { /* new object */
                            ForestNET.Lib.Global.ILogFiner(PrintIndentation() + o_jsonChild.Name + " = (" + e_jsonValueType + ")");
                            ...
                            if (o_jsonChild.Name.ToLower().Equals("properties"))
                            {
                                ...
                                ForestNET.Lib.Global.ILogFiner(PrintIndentation() + "end recursion for: " + o_jsonChild.Name + " = (" + e_jsonValueType + ")");
                            }
                            else
                            {
                                ForestNET.Lib.Global.ILogFiner(PrintIndentation() + "save current element(" + this.o_currentElement?.Name + ") in temporary variable");
                                ...
                                if (!ForestNET.Lib.Helper.MatchesRegex(o_jsonChild.Name, "[a-zA-Z0-9-_]*"))
                                {
                                ...
                                if (b_handleRootItems)
                                {
                                    ...
                                    {
                                        ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "setReference for (" + this.o_currentElement?.Name + ") with object(" + o_newJSONElement.Children[0].Name + ")");
                    ...
                    {
                        ForestNET.Lib.Global.ILogFiner(PrintIndentation() + o_jsonChild.Name + " = " + o_jsonChild.Value + " (" + e_jsonValueType + ") for " + this.o_currentElement?.Name);
        ...
        public File JsonEncode(Object? p_o_object, string p_s_jsonFile, bool p_b_overwrite, bool p_b_prettyPrint)
        {
            ...
            if (ForestNET.Lib.Global.IsILevel((byte)ForestNET.Lib.Log.Level.MASS)) ForestNET.Lib.Global.ILogMass("Encoded JSON:" + this.s_lineBreak + s_json);
        ...
        private string JsonEncodeRecursive(JSONElement p_o_jsonSchemaElement, Object? p_o_object, bool p_b_parentIsArray)
        {
            ...
            if ((ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonSchemaElement.Type)) && (ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonSchemaElement.MappingClass)))
            {
            ...
            if ((p_o_jsonSchemaElement.Type == null) || (ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonSchemaElement.Type)))
            {
            ...
            if (ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonSchemaElement.MappingClass))
            {
            ...
            if (p_o_jsonSchemaElement.Type.ToLower().Equals("object"))
            {
                ...
                if (o_object == null)
                {
                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "casted schema-object(" + p_o_jsonSchemaElement.Name + ")[parentName=" + s_jsonReferenceParentName + "] with schema-mapping(" + p_o_jsonSchemaElement.PrintMapping() + ") is null");
                    ...
                    else
                    {
                        ...
                        if (!ForestNET.Lib.Helper.IsStringEmpty(s_jsonReferenceParentName))
                        {
                ...
                else
                {
                    ...
                    if (p_o_jsonSchemaElement.Reference != null)
                    {
                        ...
                        if (p_o_jsonSchemaElement.Reference.Children.Count < 1)
                        {
                            ...
                            else
                            {
                                ...
                                ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "encode schema-object(" + p_o_jsonSchemaElement.Name + ") with its reference(" + p_o_jsonSchemaElement.Reference.Name + ") and schema-mapping(" + p_o_jsonSchemaElement.PrintMapping() + ") which has another reference with recursion");
                        ...
                        {
                            ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "encode schema-object(" + p_o_jsonSchemaElement.Name + ") with its reference(" + p_o_jsonSchemaElement.Reference.Name + ") which has children");
                    ...
                    if (b_childrenIteration)
                    {
                        ...
                        {
                            ForestNET.Lib.Global.ILogFinest(this.PrintIndentation() + "encode schema-object's(" + p_o_jsonSchemaElement.Name + ") child(" + o_jsonElement.Name + ") with schema-mapping(" + p_o_jsonSchemaElement.PrintMapping() + ") with recursion");
            ...
            else if (p_o_jsonSchemaElement.Type.ToLower().Equals("array"))
            {
                ...
                if (p_o_jsonSchemaElement.Reference != null)
                {
                    ...
                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "encode schema-array(" + p_o_jsonSchemaElement.Name + ")[parentName=" + s_jsonReferenceParentName + "] with its reference(" + p_o_jsonSchemaElement.Reference.Name + ") which has children");
                }
                else
                {
                    if (p_o_jsonSchemaElement.Children.Count != 1)
                    ...
                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "encode schema-array(" + p_o_jsonSchemaElement.Name + ")[parentName=" + s_jsonReferenceParentName + "] with child(items) which has children");
                }

                ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "encode schema-array(" + p_o_jsonSchemaElement.Name + ") - and cast object with p_o_object(" + p_o_object?.GetType().FullName + ") and schema-mapping(" + p_o_jsonSchemaElement.PrintMapping() + "), castonly if List=" + ((p_o_object != null) && (p_o_object.GetType().IsGenericType) && (p_o_object.GetType().GetGenericTypeDefinition() == typeof(List<>))));
                ...
                else if (o_object != null)
                {
                    ...
                    for (int i = 0; i < a_objects.Count; i++)
                    {
                        ...
                        if (a_objects[i] == null)
                        {
                            ForestNET.Lib.Global.ILogFinest(this.PrintIndentation() + "encode schema-array(" + p_o_jsonSchemaElement.Name + ") with array element(null) and schema-mapping(" + p_o_jsonSchemaElement.PrintMapping() + ")");

                            s_json += this.PrintIndentation() + "null," + this.s_lineBreak;
                        }
                        else if (b_primitiveArray)
                        {
                            ForestNET.Lib.Global.ILogFinest(this.PrintIndentation() + "encode schema-array(" + p_o_jsonSchemaElement.Name + ") with primitive array element(#" + (i + 1) + ") and schema-mapping(" + p_o_jsonSchemaElement.PrintMapping() + ")");
                        ...
                        {
                            ForestNET.Lib.Global.ILogFinest(this.PrintIndentation() + "encode schema-array(" + p_o_jsonSchemaElement.Name + ") with array element(" + a_objects[i]?.GetType().FullName + ") and schema-mapping(" + p_o_jsonSchemaElement.PrintMapping() + ") with recursion");
            ...
            else
            {
                ...
                ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "encode schema-property(" + p_o_jsonSchemaElement.Name + ") with p_o_object(" + p_o_object?.GetType().FullName + ")");

                /* get object property if we have not an array with items */
                if (!p_o_jsonSchemaElement.Name.ToLower().Equals("items"))
                {
                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "encode schema-property(" + p_o_jsonSchemaElement.Name + "), cast object with p_o_object(" + p_o_object?.GetType().FullName + ")");

                    /* get object property of current json element */
                    o_object = this.CastObject(p_o_jsonSchemaElement, p_o_object);
                }

                ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "encode schema-property(" + p_o_jsonSchemaElement.Name + "), cast string from object with p_o_object(" + p_o_object?.GetType().FullName + ") and schema-type(" + p_o_jsonSchemaElement.Type + ")");
        ...
        private Object? CastObject(JSONElement p_o_jsonElement, Object? p_o_object, bool b_castOnly)
        {
            ...
            else
            {
                ...
                if (!ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonElement.Mapping))
                {
        ...
        private static void CheckRestriction(string? p_s_value, JSONRestriction p_o_jsonRestriction, JSONElement p_o_jsonElement)
        {
            ...
            else if (p_o_jsonRestriction.Name.ToLower().Equals("pattern"))
            {
                ...
                {
                    if (!ForestNET.Lib.Helper.MatchesRegex(p_s_value, p_o_jsonRestriction.StrValue))
                    {
        ...
        public bool ValidateAgainstSchema(string p_s_jsonFile)
        {
            ...
            /* check if file exists */
            if (!ForestNET.Lib.IO.File.Exists(p_s_jsonFile))
            {
                throw new ArgumentException("JSON file[" + p_s_jsonFile + "] does not exist.");
            }

            /* open json file */
            ForestNET.Lib.IO.File o_file = new(p_s_jsonFile, false);
            ...
            ForestNET.Lib.Global.ILogFinest("read all lines from json file '" + p_s_jsonFile + "'");
        ...
        public bool ValidateAgainstSchema(List<string> p_a_jsonLines)
        {
            ...
            ForestNET.Lib.Global.ILogFiner("read all lines: '" + p_a_jsonLines.Count + "'");
            ...
            ForestNET.Lib.Global.ILogFinest("validated json content lines");
            ...
            ForestNET.Lib.Global.ILogFinest("parsed json content lines");
            ...
            if (ForestNET.Lib.Global.IsILevel((byte)ForestNET.Lib.Log.Level.MASS)) ForestNET.Lib.Global.ILogMass("JSON-Schema:" + ForestNET.Lib.IO.File.NEWLINE + this.o_schema);
            if (ForestNET.Lib.Global.IsILevel((byte)ForestNET.Lib.Log.Level.MASS)) ForestNET.Lib.Global.ILogMass("JSON-Root-Element:" + ForestNET.Lib.IO.File.NEWLINE + this.Root);
        ...
        private bool ValidateAgainstSchemaRecursive(JSONElement p_o_jsonDataElement, JSONElement p_o_jsonSchemaElement)
        {
            ...
            if (p_o_jsonSchemaElement.Type.ToLower().Equals("object"))
            {
                ...
                if (p_o_jsonDataElement.Children.Count > 0)
                {
                    ...
                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": create new schema-object instance with mapping[" + p_o_jsonSchemaElement.PrintMapping() + "] and type[" + s_objectType + "]");
                    ...
                    if (p_o_jsonSchemaElement.Reference != null)
                    {
                        ...
                        if (p_o_jsonSchemaElement.Reference.Children.Count < 1)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": get schema-object[" + p_o_jsonSchemaElement.MappingClass + "] with reference[" + p_o_jsonSchemaElement.Reference.Name + "]");
                        ...
                        {
                            ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "update current schema-element[" + p_o_jsonSchemaElement.Name + "](" + p_o_jsonSchemaElement.PrintMapping() + ") with reference[" + p_o_jsonSchemaElement.Reference.Name + "](" + p_o_jsonSchemaElement.Reference.PrintMapping() + ")");
                    ...
                    if (b_childrenIteration)
                    {
                        ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": get schema-object with type[" + p_o_jsonSchemaElement.MappingClass + "] and children[" + p_o_jsonSchemaElement.Children.Count + "]");
                        ...
                        if (p_o_jsonDataElement.Children.Count > 0)
                        {
                            ...
                            {
                                ForestNET.Lib.Global.ILogFinest(this.PrintIndentation() + "compare schema-child-name(" + p_o_jsonSchemaElement.Children[i].Name + ") with data-child-name(" + p_o_jsonDataElement.Children[j].Name + ")");
            ...
            else if (p_o_jsonSchemaElement.Type.ToLower().Equals("array"))
            {
                ...
                if (ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonDataElement.Value))
                { /* we have multiple minor objects for current array */
                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": get schema-array with mapping[" + p_o_jsonSchemaElement.PrintMapping() + "]");
                ...
                { /* array objects must be retrieved out of value property */
                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": handle array value = " + p_o_jsonDataElement.Value + " - mapping[" + p_o_jsonSchemaElement.PrintMapping() + "]");

                    /* set array with values if we have any values */
                    if ((p_o_jsonDataElement.Value != null) && (!ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonDataElement.Value)) && (!p_o_jsonDataElement.Value.Equals("[]")))
                    {
                        ...
                        foreach (string s_foo in a_values)
                        {
                            ...
                            ForestNET.Lib.Global.ILogFinest(this.PrintIndentation() + "add value[" + (o_returnObject ?? "null") + "] to list of " + p_o_jsonDataElement.Name + ", type[" + ((o_returnObject == null) ? "null" : o_returnObject.GetType().FullName) + "]");
                        }
                    }
                    else if (b_required)
            ...
            {
                ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": handle value = " + p_o_jsonDataElement.Value + " - mapping[" + p_o_jsonSchemaElement.PrintMapping() + "]");

                JSONValueType e_jsonValueType = JSON.GetJSONValueType(p_o_jsonDataElement.Value);

                ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": json value type = " + e_jsonValueType);
                ...
                {
                    if ((ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonSchemaElement.Mapping)) && (ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonSchemaElement.MappingClass)))
                    {
            ...
            ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "return " + b_return);
        ...
        public Object? JsonDecode(string p_s_jsonFile)
        {
            ...
            ForestNET.Lib.Global.ILogFiner("read all lines from json file '" + p_s_jsonFile + "'");
        ...
        public Object? JsonDecode(List<string> p_a_jsonLines)
        {
            ...
            ForestNET.Lib.Global.ILogFinest("decoded json content lines");
        ...
        private Object? JsonDecodeRecursive(JSONElement p_o_jsonDataElement, JSONElement p_o_jsonSchemaElement, Object? p_o_object)
        {
            ...
            /* check if type is set */
            if (ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonSchemaElement.Type))
            {
                throw new ArgumentException("Schema-element[" + p_o_jsonSchemaElement.Name + "] has no type");
            }
            ...
            if ((p_o_jsonSchemaElement.Type == null) || (p_o_jsonSchemaElement.Type.ToLower().Equals("object")))
            {
                ...
                else
                {
                    ...
                    if (!ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonSchemaElement.Mapping))
                    {
                    ...
                    if (p_o_jsonSchemaElement.Reference != null)
                    {
                        ...
                        if (p_o_jsonSchemaElement.Reference.Children.Count < 1)
                        {
                            ...
                            else
                            {
                                ...
                                if (p_o_jsonSchemaElement.Name.Equals(p_o_jsonDataElement.Name))
                                {
                                    ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": get schema-object[" + o_object?.GetType().FullName + "] with reference[" + p_o_jsonSchemaElement.Reference.Name + "]");
                    ...
                    if (b_childrenIteration)
                    {
                        ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": get schema-object with type[" + o_object?.GetType().FullName + "] and children[" + p_o_jsonSchemaElement.Children.Count + "]");
                        ...
                        {
                            ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + p_o_jsonSchemaElement.Name + ": set schema-object[" + o_object?.GetType().FullName + "] to current object[" + p_o_object?.GetType().FullName + "] with mapping[" + s_objectMapping + "]");
            ...
            else if (p_o_jsonSchemaElement.Type.ToLower().Equals("array"))
            {
                ...
                if ((p_o_jsonSchemaElement.Children.Count > 0) && (p_o_jsonSchemaElement.Children[0].PrimitiveArray))
                {
                    ...
                    else
                    {
                        ...
                        else if (!(ForestNET.Lib.Helper.IsStringEmpty(p_o_jsonSchemaElement.MappingClass)))
                        {
                ...
                else
                {
                    ...
                    { /* we have to retrieve the list object */
                        ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "p_o_object(" + p_o_object.GetType().FullName + ") != null, get list property " + p_o_jsonSchemaElement.Name);
                ...
                { /* we have multiple minor objects for current array */
                    ...
                    { /* if we have objects to the new array */
                        ...
                        for (int i = 0; i < p_o_jsonDataElement.Children.Count; i++)
                        {
                            ...
                            ForestNET.Lib.Global.ILogFinest(this.PrintIndentation() + "add return value to list of " + p_o_jsonDataElement.Name + ", type[" + ((o_returnObject == null) ? "object is null" : o_returnObject.GetType().FullName) + "]");
            ...
            ForestNET.Lib.Global.ILogFiner(this.PrintIndentation() + "return " + ((p_o_object == null) ? "null" : p_o_object.GetType().FullName));
            return p_o_object;
        }
        ...
        private void SetFieldOrProperty(JSONElement p_o_jsonSchemaElement, Object? p_o_object, string? p_s_objectValue)
        {
            ...
            if (this.UseProperties)
            {
                ...
                {
                    ForestNET.Lib.Global.ILogFinest(this.PrintIndentation() + o_exc.Message + " - with type[" + p_o_jsonSchemaElement.Type + "] - try another cast with type[" + o_propertyInfo.PropertyType.FullName + "]");
            ...
            else
            {
                ...
                {
                    ForestNET.Lib.Global.ILogFinest(this.PrintIndentation() + o_exc.Message + " - with type[" + p_o_jsonSchemaElement.Type + "]  - try another cast with type[" + o_fieldInfo.FieldType.FullName + "]");
        ...
        public class JSONRestriction
        {
            ...
            override public string ToString()
            {
                string s_foo = ForestNET.Lib.IO.File.NEWLINE + this.PrintIndentation() + "\t" + "JSONRestriction: ";

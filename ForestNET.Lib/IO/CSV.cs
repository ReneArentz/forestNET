    ...
    public class CSV
    {
        ...
        public string Delimiter
        {
            ...
            set
            {
                ...
                ForestNET.Lib.Global.ILogConfig("updated delimiter to '" + this.s_delimiter + "'");
            }
        }
        ...
        public string ArrayDelimiter
        {
            ...
            set
            {
                ...
                ForestNET.Lib.Global.ILogConfig("updated array delimiter to '" + this.s_arrayDelimiter + "'");
            }
        }
        ...
        public string LineBreak
        {
            ...
            set
            {
                ...
                ForestNET.Lib.Global.ILogConfig("updated line break to [" + ForestNET.Lib.Helper.BytesToHexString(this.o_encoding.GetBytes(this.s_lineBreak), true) + "]");
            }
        }
        ...
        public Encoding Encoding
        {
            ...
            set
            {
                ...
                ForestNET.Lib.Global.ILogConfig("updated encoding to '" + this.o_encoding.ToString() + "'");
            }
        }
        ...
        public CSV(string p_s_delimiter, string p_s_arrayDelimiter)
        {
            ...
            this.s_lineBreak = ForestNET.Lib.IO.File.NEWLINE;
        ...
        /// <returns>ForestNET.Lib.IO.File object</returns>
        ...
        public File EncodeCSV(Object p_o_object, string p_s_csvFile, bool p_b_printHeader, bool p_b_overwrite)
        {
            ...
            /* open (new) file */
            ForestNET.Lib.IO.File o_file = new(p_s_csvFile, this.o_encoding, !p_b_overwrite, ForestNET.Lib.IO.File.NEWLINE);
        ...
        private string GenerateHeaderLine(Object p_o_object)
        {
            ...
            if (!this.UseProperties) /* read all fields of object parameter */
            {
                ...
                foreach (System.Reflection.FieldInfo o_fieldInfo in p_o_object.GetType().GetFields())
                {
                    ...
                    ForestNET.Lib.Global.ILogFiner("iterate all fields - field '" + o_fieldInfo.Name + "' with type '" + o_fieldInfo.FieldType.FullName + "'");
                    ...
                    {
                        ForestNET.Lib.Global.ILogFiner("iterate all fields - array element type '" + o_fieldInfo.FieldType.GenericTypeArguments[0].FullName + "'");
                        ...
                        {
                            ForestNET.Lib.Global.ILogFinest("skip generic list field - type '" + o_fieldInfo.FieldType.GenericTypeArguments[0].FullName + "' not allowed");
                            continue;
                        }
                    }
                    ...
                    {
                        ForestNET.Lib.Global.ILogFinest("skip array field - type '" + o_fieldInfo.FieldType.GetElementType()?.FullName + "' not allowed");
                        continue;
                    }
                    ...
                    {
                        ForestNET.Lib.Global.ILogFinest("skip field - type '" + o_fieldInfo.FieldType.FullName + "' not allowed");
                        continue;
                    }
                    else if ((o_fieldInfo.IsStatic) || (o_fieldInfo.IsLiteral && !o_fieldInfo.IsInitOnly)) /* if field is static or const, skip this field */
                    {
                        ForestNET.Lib.Global.ILogFinest("skip field - field is static or const");
                        continue;
                    }
            ...
            else /* read all properties of object parameter */
            {
                ...
                foreach (System.Reflection.PropertyInfo o_propertyInfo in p_o_object.GetType().GetProperties())
                {
                    ...
                    ForestNET.Lib.Global.ILogFiner("iterate all properties - property '" + o_propertyInfo.Name + "' with type '" + o_propertyInfo.PropertyType.FullName + "'");
                    ...
                    {
                        ForestNET.Lib.Global.ILogFiner("iterate all properties - array element type '" + o_propertyInfo.PropertyType.GenericTypeArguments[0].FullName + "'");
                        ...
                        {
                            ForestNET.Lib.Global.ILogFinest("skip generic list property - type '" + o_propertyInfo.PropertyType.GenericTypeArguments[0].FullName + "' not allowed");
                            continue;
                        }
                    }
                    ...
                    {
                        ForestNET.Lib.Global.ILogFinest("skip array property - type '" + o_propertyInfo.PropertyType.GetElementType()?.FullName + "' not allowed");
                        continue;
                    }
                    ...
                    {
                        ForestNET.Lib.Global.ILogFinest("skip property - type '" + o_propertyInfo.PropertyType.FullName + "' not allowed");
                        continue;
                    }
                    else if (!o_propertyInfo.CanRead) /* if property value cannot be read */
                    {
                        ForestNET.Lib.Global.ILogFinest("skip property '" + o_propertyInfo.Name + "' - type '" + o_propertyInfo.PropertyType.FullName + "' - cannot read it's value");
                        continue;
                    }
        ...
        public void DecodeCSV<T>(string p_s_csvFile, ref T p_o_object)
        {
            ...
            /* open csv file */
            ForestNET.Lib.IO.File o_file = new(p_s_csvFile, this.o_encoding, false, ForestNET.Lib.IO.File.NEWLINE);
        ...
        private void DecodeCSVFile<T>(string p_s_csvContent, ref T p_o_object)
        {
            ...
            if (a_csvLines.Length > 0)
            {
                ...
                ForestNET.Lib.Global.ILogFiner("Generated header line:\t" + s_headerLine);
                ForestNET.Lib.Global.ILogFiner("First line from file:\t" + a_csvLines[0]);
                ...
                for (int i = i_start; i < a_csvLines.Length; i++)
                {
                    ...
                    if (ForestNET.Lib.Helper.IsStringEmpty(a_csvLines[i]))
                    {
                        /* go to next line */
                        continue;
                    }
                    ...
                    foreach (string s_csvColumnValue in a_csvColumns)
                    {
                        ...
                        ForestNET.Lib.Global.ILogFiner("Field name '" + a_fieldNames[k] + "' of line '" + (i + 1) + "' gets value '" + s_foo + "'");
        ...
        private void SetValue(string p_s_fieldName, Object? p_o_object, string p_s_objectValue)
        {
            ...
            if ((p_o_object.GetType().IsGenericType) && (p_o_object.GetType().GetGenericTypeDefinition() == typeof(List<>))) /* check if parameter object is a generic list */
            {
                ...
                if (!ForestNET.Lib.Helper.IsStringEmpty(p_s_objectValue))
                {
        ...
        private void SetValueForArraysOrLists(string p_s_fieldName, Object p_o_object, string p_s_objectValue, bool p_b_forArray)
        {
            ...
            if (!ForestNET.Lib.Helper.IsStringEmpty(p_s_objectValue))
            {
                ...
                if (s_arrayType == null)
                {
                    ForestNET.Lib.Global.ILogFiner("Field/Property " + ((p_b_forArray) ? "array" : "list") + " '" + p_s_fieldName + "' has element type 'null' which is not allowed. Will be skipped.");
                    return;
                }
                ...
                {
                    ForestNET.Lib.Global.ILogFiner("Field/Property " + ((p_b_forArray) ? "array" : "list") + " '" + p_s_fieldName + "' has element type '" + s_arrayType + "' which is not allowed. Will be skipped.");
                    return;
                }

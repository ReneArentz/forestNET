namespace ForestNET.Lib.IO
{
    ...
    /// </summary>
    public abstract class FileSystemWatcher : ForestNET.Lib.TimerTask
    {
        ...
        private ForestNET.Lib.Timer? o_timerObject;
        ...
        public bool Recursive
        {
            ...
            set
            {
                ...
                ForestNET.Lib.Global.ILogConfig("updated recursive to '" + value + "'");
            }
        }
        ...
        public bool Create
        {
            ...
            {
                this.b_create = value;
                ForestNET.Lib.Global.ILogConfig("updated create to '" + value + "'");
            }
        }
        ...
        public bool Change
        {
            ...
            {
                this.b_change = value;
                ForestNET.Lib.Global.ILogConfig("updated change to '" + value + "'");
            }
        }
        ...
        public bool Delete
        {
            ...
            {
                this.b_delete = value;
                ForestNET.Lib.Global.ILogConfig("updated delete to '" + value + "'");
            }
        }
        ...
        public bool Access
        {
            ...
            {
                this.b_access = value;
                ForestNET.Lib.Global.ILogConfig("updated access to '" + value + "'");
            }
        }
        ...
        public string FileExtensionFilter
        {
            ...
            set
            {
                ...
                ForestNET.Lib.Global.ILogConfig("updated file extension filter to '" + value + "'");
            }
        }
        ...
        public FileSystemWatcher(string p_s_directory, ForestNET.Lib.DateInterval p_o_interval) : this(p_s_directory, p_o_interval, System.TimeSpan.Zero)
        {
        ...
        /// <exception cref="ArgumentException">directory parameter is not a valid path</exception>
        public FileSystemWatcher(string p_s_directory, ForestNET.Lib.DateInterval p_o_interval, System.TimeSpan p_o_startTime) : base(p_o_interval, p_o_startTime)
        {
        ...
        private System.Collections.Generic.List<string> GetFileExtensionFilter()
        {
            ...
            if (!ForestNET.Lib.Helper.IsStringEmpty(this.s_fileExtensionFilter))
            {
                ...
                foreach (ListingElement o_listingElement in File.ListDirectory(this.s_directory, this.b_recursive))
                {
                    ...
                    if ((a_filter.Count > 0) && (o_listingElement.Name != null))
                    {
                        ...
                        if (!a_filter.Contains("*.*"))
                        {
                            ...
                            {
                                ForestNET.Lib.Global.ILog(s_filter + " - " + o_listingElement.Name);
                    ...
                    ForestNET.Lib.Global.ILogFinest("Added file on start of file system watcher to have it's initial state [" + o_listingElement.FullName + "]");
                }

                /* create timer object and start timer */
                this.o_timerObject = new ForestNET.Lib.Timer(this);
                this.Stop = false;
                this.o_timerObject.StartTimer();
                ForestNET.Lib.Global.ILogFiner("File system watcher has been started");
            }
            else
            {
                ForestNET.Lib.Global.ILog("File system watcher already has been started - no action has been done");
            }
        }
        ...
        public void StopWatcher()
        {
            ...
            if (this.o_timerObject != null)
            {
                ...
                this.o_timerObject = null;
                ForestNET.Lib.Global.ILogFiner("File system watcher has been stopped");
            }
            else
            {
                ForestNET.Lib.Global.ILog("File system watcher already has been stopped or never started - no action has been done");
            }
        }
        ...
        override public void RunTimerTask()
        {
            ...
            foreach (ListingElement o_listingElement in this.a_files)
            {
                ...
                { /* file still exists */
                    ...
                    if (this.b_change)
                    {
                        ...
                        {
                            /* fire change event */
                            ForestNET.Lib.Global.ILogFinest("fire change event '" + o_compareListingElement.FullName + "'");
                    ...
                    if (this.b_access)
                    {
                        ...
                        {
                            /* fire access event */
                            ForestNET.Lib.Global.ILogFinest("fire access event '" + o_compareListingElement.FullName + "'");
                ...
                { /* file was deleted */
                    ...
                    {
                        /* fire delete event */
                        ForestNET.Lib.Global.ILogFinest("fire delete event '" + o_listingElement.FullName + "'");
            ...
            foreach (ListingElement o_listingElement in a_currentFiles)
            {
                ...
                {
                    /* fire create event */
                    ForestNET.Lib.Global.ILogFinest("fire create event '" + o_listingElement.FullName + "'");

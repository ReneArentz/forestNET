...
namespace ForestNETTests.IO
{
    ...
    public class Data
    {
        public static List<ShipOrder> GenerateData()
        {
            ...
            {
                ForestNETLib.Core.Global.LogException(o_exc);
            }
            ...
            override public string ToString()
            {
                ...
                foreach (PropertyInfo o_property in this.GetType().GetProperties())
                {
                    ...
                    try
                    {
                        ...
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList([.. (decimal[])(o_property.GetValue(this) ?? new List<decimal>())]);
                        }
                        else
                        {
                            s_value = o_property.GetValue(this)?.ToString() ?? "null";
            ...
            override public string ToString()
            {
                ...
                foreach (PropertyInfo o_property in this.GetType().GetProperties())
                {
                    ...
                    try
                    {
                        ...
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList([.. (bool[])(o_property.GetValue(this) ?? new List<bool>())]);
                        }
                        else if ((o_property.PropertyType.IsGenericType) && (o_property.PropertyType.GetGenericTypeDefinition() == typeof(List<>)))
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList((List<ShipItem>)(o_property.GetValue(this) ?? new List<ShipItem>()));
                        }
                        else
                        {
                            s_value = o_property.GetValue(this)?.ToString() ?? "null";
            ...
            override public string ToString()
            {
                ...
                foreach (PropertyInfo o_property in this.GetType().GetProperties())
                {
                    ...
                    try
                    {
                        ...
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList((List<ShipOrder>)(o_property.GetValue(this) ?? new List<ShipOrder>()));
                        }
                        else
                        {
                            s_value = o_property.GetValue(this)?.ToString() ?? "null";
            ...
            override public string ToString()
            {
                ...
                foreach (FieldInfo o_field in this.GetType().GetFields())
                {
                    ...
                    try
                    {
                        ...
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList([.. (float[])(o_field.GetValue(this) ?? new List<float>())]);
                        }
                        else if ((o_field.FieldType.IsGenericType) && (o_field.FieldType.GetGenericTypeDefinition() == typeof(List<>)))
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList((List<int>)(o_field.GetValue(this) ?? new List<int>()));
                        }
                        else
                        {
                ...
                foreach (PropertyInfo o_property in this.GetType().GetProperties())
                {
                    ...
                    try
                    {
                        ...
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList([.. (float[])(o_property.GetValue(this) ?? new List<float>())]);
                        }
                        else if ((o_property.PropertyType.IsGenericType) && (o_property.PropertyType.GetGenericTypeDefinition() == typeof(List<>)))
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList((List<int>)(o_property.GetValue(this) ?? new List<int>()));
                        }
                        else
                        {
                            s_value = o_property.GetValue(this)?.ToString() ?? "null";
            ...
            override public string ToString()
            {
                ...
                foreach (FieldInfo o_field in this.GetType().GetFields())
                {
                    ...
                    try
                    {
                        ...
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList((List<SimpleClass>)(o_field.GetValue(this) ?? new List<SimpleClass>()));
                        }
                        else
                        {
                            s_value = o_field.GetValue(this)?.ToString() ?? "null";
                ...
                foreach (PropertyInfo o_property in this.GetType().GetProperties())
                {
                    ...
                    try
                    {
                        if ((o_property.PropertyType.IsGenericType) && (o_property.PropertyType.GetGenericTypeDefinition() == typeof(List<>)))
                        {
                            s_value = ForestNETLib.Core.Helper.PrintArrayList((List<SimpleClass>)(o_property.GetValue(this) ?? new List<SimpleClass>()));
                        }
                        else
                        {
                            s_value = o_property.GetValue(this)?.ToString() ?? "null";

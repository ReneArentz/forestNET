    ...
    public class CSVUnitTest
    {
        ...
        public void TestCSV()
        {
            try
            {
                ...
                string s_file = s_currentDirectory + ForestNETLib.IO.File.DIR + "file.csv";

                ForestNETLib.IO.CSV o_csv = new(";", "*");

                if (ForestNETLib.IO.File.Exists(s_file)) ForestNETLib.IO.File.DeleteFile(s_file);
                Assert.That(ForestNETLib.IO.File.Exists(s_file), Is.False, "file[" + s_file + "] does exist");
        ...
        private static void CSVClass(ForestNETLib.IO.CSV p_o_csv, string p_s_file)
        {
            ...
            ForestNETLib.IO.File o_file = p_o_csv.EncodeCSV(o_recordOut, p_s_file, true, true);

            ForestNETTests.SQL.AllTypesRecord o_recordIn = new();
            p_o_csv.DecodeCSV(p_s_file, ref o_recordIn);

            Assert.That(
                ForestNETLib.Core.Helper.ObjectsEqualUsingReflections(o_recordOut, o_recordIn, p_o_csv.UseProperties),
                Is.True,
        ...
        private static void CSVClassArray(ForestNETLib.IO.CSV p_o_csv, string p_s_file)
        {
            List<ForestNETTests.SQL.AllTypesRecord> a_recordsOut = [];

            ForestNETTests.SQL.AllTypesRecord o_recordTemp = new()
            {
                ColumnId = 1,
                ColumnUUID = "ab1824ce-72b8-4aad-bb12-dbc448682437",
                ColumnShortText = "Datensatz Eins",
            ...
            o_recordTemp = new ForestNETTests.SQL.AllTypesRecord
            {
                ColumnId = 2,
            ...
            ForestNETLib.IO.File o_file = p_o_csv.EncodeCSV(a_recordsOut, p_s_file, true, true);

            List<ForestNETTests.SQL.AllTypesRecord> a_recordsIn = [];
            p_o_csv.DecodeCSV(p_s_file, ref a_recordsIn);

            Assert.That(
                ForestNETLib.Core.Helper.ObjectsEqualUsingReflections(a_recordsOut, a_recordsIn, p_o_csv.UseProperties),
                Is.True,
        ...
        private static void CSVInnerClass(ForestNETLib.IO.CSV p_o_csv, string p_s_file)
        {
            ForestNETTests.IO.Data.ShipItem o_shipItemOut = new()
            {
                Title = "Item #1",
                Note = "high; value",
                ...
                ShipItemInfo = new ForestNETTests.IO.Data.ShipItemInfo()
            };
            ...
            ForestNETLib.IO.File o_file = p_o_csv.EncodeCSV(o_shipItemOut, p_s_file, true, true);

            ForestNETTests.IO.Data.ShipItem o_shipItemIn = new();
            p_o_csv.DecodeCSV(p_s_file, ref o_shipItemIn);

            Assert.That(
                ForestNETLib.Core.Helper.ObjectsEqualUsingReflections(o_shipItemOut, o_shipItemIn, p_o_csv.UseProperties),
                Is.True,
        ...
        private static void CSVInnerClassArray(ForestNETLib.IO.CSV p_o_csv, string p_s_file)
        {
            ...
            ForestNETLib.IO.File o_file = p_o_csv.EncodeCSV(a_dataOut, p_s_file, true, true);
            ...
            Assert.That(
                ForestNETLib.Core.Helper.ObjectsEqualUsingReflections(a_dataOut, a_dataIn, p_o_csv.UseProperties),
                Is.True,
        ...
        private static void CSVOtherInnerClass(ForestNETLib.IO.CSV p_o_csv, string p_s_file)
        {
            ForestNETTests.IO.Data.ShipOrder o_shipOrderOut = new()
            {
                OrderId = "ORD0001",
                OrderPerson = "Jon Doe",
            ...
            ForestNETLib.IO.File o_file = p_o_csv.EncodeCSV(o_shipOrderOut, p_s_file, true, true);

            Data.ShipOrder o_shipOrderIn = new();
            p_o_csv.DecodeCSV(p_s_file, ref o_shipOrderIn);

            Assert.That(
                ForestNETLib.Core.Helper.ObjectsEqualUsingReflections(o_shipOrderOut, o_shipOrderIn, p_o_csv.UseProperties),
                Is.True,
        ...
        private static void CSVOtherInnerClassArray(ForestNETLib.IO.CSV p_o_csv, string p_s_file)
        {
            ForestNETTests.IO.Data.ShipItem o_shipItem1 = new()
            {
                Title = "Item #1",
                Note = "----",
            ...
            ForestNETTests.IO.Data.ShipItem o_shipItem2 = new()
            {
                Title = "Item #2",
                Note = "be careful",
            ...
            ForestNETTests.IO.Data.ShipItem o_shipItem3 = new()
            {
                Title = "Item #3",
                Note = "store cold",
            ...
            List<ForestNETTests.IO.Data.ShipItem> a_dataShipItemOut =
            [
                o_shipItem1,
                o_shipItem2,
                o_shipItem3
            ...
            ForestNETLib.IO.File o_file = p_o_csv.EncodeCSV(a_dataShipItemOut, p_s_file, true, true);

            List<ForestNETTests.IO.Data.ShipItem> a_dataShipItemIn = [];
            p_o_csv.DecodeCSV(p_s_file, ref a_dataShipItemIn);

            Assert.That(
                ForestNETLib.Core.Helper.ObjectsEqualUsingReflections(a_dataShipItemOut, a_dataShipItemIn, p_o_csv.UseProperties),
                Is.True,

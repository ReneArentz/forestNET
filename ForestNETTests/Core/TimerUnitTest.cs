    ...
    public class TimerUnitTest
    {
        ...
        public void TestTimer()
        {
            try
            {
                ...
                string s_testDirectory = s_currentDirectory + ForestNETLib.IO.File.DIR + "testTimer" + ForestNETLib.IO.File.DIR;
                ...
                ForestNETLib.Core.Timer o_timer;
        ...
        internal class TestTimerTask : ForestNETLib.Core.TimerTask
        {
            private int i_cnt = 1;
            private readonly string s_file;

            public TestTimerTask(ForestNETLib.Core.DateInterval p_o_interval, System.TimeSpan p_o_startTime, string p_s_file) : base(p_o_interval, p_o_startTime)
            {
            ...
            {
                ForestNETLib.IO.File o_file = new(s_file);

namespace ForestNETTests.SQL
{
    public class AllTypesRecord
    {
        ...
        public DateTime ColumnTimestamp = default;
        public DateTime ColumnDate = default;
        public TimeSpan ColumnTime = default;
        public TimeSpan ColumnLocalTime = default;
        public DateTime ColumnLocalDate = default;
        public DateTime ColumnLocalDateTime = default;

namespace ForestNETLib.Core
{
    ...
    public abstract class TimerTask
    {
        ...
        public ForestNETLib.Core.DateInterval Interval { get; private set; }
        ...
        public TimerTask(ForestNETLib.Core.DateInterval p_o_interval) : this(p_o_interval, System.TimeSpan.Zero)
        {
        ...
        public TimerTask(ForestNETLib.Core.DateInterval p_o_interval, System.TimeSpan p_o_startTime)
        {
            ...
            ForestNETLib.Core.Global.ILogConfig("Created TimerTask with interval '" + p_o_interval + "' and start time '" + p_o_startTime + "'");
        }
        ...
        public void ClearExcludeWeekdays()
        {
            ...
            ForestNETLib.Core.Global.ILogConfig("Exclude weekday settings cleared");
        }
        ...
        public void ExcludeWeekday(System.DayOfWeek p_e_dayOfWeek)
        {
            if (!this.a_excludeWeekdays.Contains(p_e_dayOfWeek))
            {
                ...
                ForestNETLib.Core.Global.ILogConfig("Exclude weekday '" + p_e_dayOfWeek + "'");
            }
        }
        ...
        public System.Threading.Tasks.Task Run()
        {
            ...
            {
                ForestNETLib.Core.Global.ILogConfig("Weekday '" + o_dayOfWeek + "' is excluded");
            }

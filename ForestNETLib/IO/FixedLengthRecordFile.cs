namespace ForestNETLib.IO
{
    ...
    public class FixedLengthRecordFile
    {
        ...
        {
            if ((p_o_groupHeader != null) && ((ForestNETLib.Core.Helper.IsStringEmpty(p_s_regexGroupHeader)) ^ (p_i_knownLengthGroupHeader < 0)))
            {
                this.GroupHeader = new FLRType(p_o_groupHeader, p_s_regexGroupHeader, p_i_knownLengthGroupHeader);
            }

            if ((p_o_groupFooter != null) && ((ForestNETLib.Core.Helper.IsStringEmpty(p_s_regexGroupFooter)) ^ (p_i_knownLengthGroupFooter < 0)))
            {
            ...
            if ((ForestNETLib.Core.Helper.IsStringEmpty(p_s_regexFLR)) && (p_i_knownLengthFLR < 0))
            {
        ...
        public void AddFLRType(FLRType p_o_flrType)
        {
            ...
            foreach (FLRType o_flrType in this.FLRTypes)
            {
                ...
                if (((!ForestNETLib.Core.Helper.IsStringEmpty(p_o_flrType.RegexFLR)) && ((o_flrType.RegexFLR ?? "").Equals(p_o_flrType.RegexFLR))) && (o_flrType.KnownLengthFLR == p_o_flrType.KnownLengthFLR))
                {
        ...
        {
            this.ReadFile(p_s_file, System.Text.Encoding.GetEncoding(ForestNETLib.IO.File.ENCODING), false);
        }
        ...
        public void ReadFile(string p_s_file, System.Text.Encoding p_o_encoding, bool p_b_ignroeUniqueConstraint)
        {
            ...
            foreach (string s_line in a_flrLines)
            {
                ...
                if ((this.GroupHeader != null) &&
                        (
                            (!ForestNETLib.Core.Helper.IsStringEmpty(this.GroupHeader.RegexFLR)) && (ForestNETLib.Core.Helper.MatchesRegex(s_line, this.GroupHeader.RegexFLR ?? "")) ||
                    ...
                    )
                {
                    ...
                    (
                            (!ForestNETLib.Core.Helper.IsStringEmpty(this.GroupFooter.RegexFLR)) && (ForestNETLib.Core.Helper.MatchesRegex(s_line, this.GroupFooter.RegexFLR ?? "")) ||
                ...
                { /* check for other flr types */
                    ...
                    foreach (FLRType o_flrType in this.FLRTypes)
                    {
                        ...
                        if ((!ForestNETLib.Core.Helper.IsStringEmpty(o_flrType.RegexFLR)) && (!ForestNETLib.Core.Helper.MatchesRegex(s_line, o_flrType.RegexFLR ?? "")))
                        {
                            continue;
                        }
        ...
        private static IFixedLengthRecord? ReadFileLineRecursive(string p_s_line, ReadState p_e_readState, IFixedLengthRecord? p_o_flrType, int p_i_stackNumber, int p_i_flrNumber, bool p_b_ignroeUniqueConstraint)
        {
            ...
            if (p_e_readState == ReadState.GROUPHEADER)
            {
                ...
                catch (InvalidOperationException o_exc)
                {
                    ...
                    {
                        ForestNETLib.Core.Global.ILog("could not parse group header of stack #" + (p_i_stackNumber + 1) + ": " + o_exc);
                    }
                }
            }
            ...
            { /* read fixed length records */
                ...
                catch (InvalidOperationException o_exc)
                {
                    ...
                    {
                        ForestNETLib.Core.Global.ILog("could not parse fixed length record #" + (p_i_flrNumber + 1) + " within stack #" + (p_i_stackNumber + 1) + ": " + o_exc);
                    }
                }
            }
            ...
            { /* read group footer */
                ...
                catch (InvalidOperationException o_exc)
                {
                    ...
                    {
                        ForestNETLib.Core.Global.ILog("could not parse group footer of stack #" + (p_i_stackNumber + 1) + ": " + o_exc);
                    }
                }
            }
        ...
        {
            this.WriteFile(p_s_file, System.Text.Encoding.GetEncoding(ForestNETLib.IO.File.ENCODING));
        }
        ...
        public class FLRType
        {
            ...
            public string? RegexFLR
            {
                ...
                set
                {
                    ...
                    if (!ForestNETLib.Core.Helper.IsStringEmpty(value))
                    {
                        try
                        {

namespace ForestNETLib.IO
{
    ...
    public class StandardTransposeMethods
    {
        ...
        public class Numbers
        {
            ...
            {
                /* check byte value */
                if (!ForestNETLib.Core.Helper.IsByte(p_s_value ?? "null"))
                {
            ...
            public static Object? TransposeSignedByte(string? p_s_value)
            {
                ...
                if (!ForestNETLib.Core.Helper.IsSByte(p_s_value ?? "null"))
                {
            ...
            public static Object? TransposeSignedByteWithSign(string? p_s_value)
            {
                ...
                /* check byte value */
                if (!ForestNETLib.Core.Helper.IsSByte(p_s_value))
                {
                    throw new InvalidCastException("Value '" + p_s_value + "' cannot be cast to SByte");
                }
            ...
            {
                /* check short value */
                if (!ForestNETLib.Core.Helper.IsShort(p_s_value ?? "null"))
                {
            ...
            public static Object? TransposeShortWithSign(string? p_s_value)
            {
                ...
                /* check short value */
                if (!ForestNETLib.Core.Helper.IsShort(p_s_value))
                {
                    throw new InvalidCastException("Value '" + p_s_value + "' cannot be cast to Short");
                }
            ...
            {
                /* check integer value */
                if (!ForestNETLib.Core.Helper.IsInteger(p_s_value ?? "null"))
                {
            ...
            public static Object? TransposeIntegerWithSign(string? p_s_value)
            {
                ...
                /* check integer value */
                if (!ForestNETLib.Core.Helper.IsInteger(p_s_value))
                {
                    throw new InvalidCastException("Value '" + p_s_value + "' cannot be cast to Integer");
                }
            ...
            {
                /* check long value */
                if (!ForestNETLib.Core.Helper.IsLong(p_s_value ?? "null"))
                {
            ...
            public static Object? TransposeLongWithSign(string? p_s_value)
            {
                ...
                /* check long value */
                if (!ForestNETLib.Core.Helper.IsLong(p_s_value))
                {
                    throw new InvalidCastException("Value '" + p_s_value + "' cannot be cast to Long");
                }
            ...
            {
                /* check ushort value */
                if (!ForestNETLib.Core.Helper.IsUShort(p_s_value ?? "null"))
                {
            ...
            public static Object? TransposeUnsignedInteger(string? p_s_value)
            {
                ...
                if (!ForestNETLib.Core.Helper.IsUInteger(p_s_value ?? "null"))
                {
            ...
            {
                /* check ulong value */
                if (!ForestNETLib.Core.Helper.IsULong(p_s_value ?? "null"))
                {
        ...
        public class DateTime
        {
            ...
            private static System.DateTime? TransposeDateTime_any(string? p_s_value)
            {
                ...
                {
                    return ForestNETLib.Core.Helper.FromDateTimeString(p_s_value);
                }
            }
            ...
            public static Object? TransposeDateTime_ISO8601(string? p_s_value)
            {
                ...
                {
                    return ForestNETLib.Core.Helper.FromISO8601UTC(p_s_value);
                }
            }
            ...
            private static string TransposeDateTime_ISO8601(Object? p_o_value, int p_i_length, bool p_b_noSeparator)
            {
                ...
                if (p_o_value is System.DateTime o_foo)
                {
                    ...
                    /* return date time string with set length */
                    return ForestNETLib.Core.Helper.ToISO8601UTC(o_foo).Substring(0, p_i_length).Replace("T", s_replaceSeparator);
                }
                else
                {
                    throw new InvalidCastException("Parameter '" + p_o_value + "' is not a DateTime");
            ...
            public static string TransposeDateTime_RFC1123(Object? p_o_value, int p_i_length)
            {
                ...
                {
                    /* return date time string with set length */
                    return ForestNETLib.Core.Helper.ToRFC1123(o_foo).Substring(0, p_i_length);
                }
                else
                {
                    throw new InvalidCastException("Parameter '" + p_o_value + "' is not a DateTime");
            ...
            public static Object? TransposeDateTime_hhiiss(string? p_s_value)
            {
                ...
                System.TimeSpan o_timeSpan = ForestNETLib.Core.Helper.FromTimeString(p_s_value);
        ...
        public class TimeSpan
        {
            ...
            private static System.TimeSpan? TransposeTimeSpan_any(string? p_s_value)
            {
                ...
                {
                    return ForestNETLib.Core.Helper.FromTimeString(p_s_value);
                }
            }
        ...
        public class FloatingPointNumbers
        {
            ...
            public static Object? TransposeFloat(string? p_s_value, int p_i_positionDecimalSeparator)
            {
                ...
                if ((ForestNETLib.Core.Helper.MatchesRegex(p_s_value, "^[0]+$")) || (ForestNETLib.Core.Helper.MatchesRegex(p_s_value, "^\\+[0]+$")) || (ForestNETLib.Core.Helper.MatchesRegex(p_s_value, "^-[0]+$")))
                {
                ...
                /* check float value */
                if (!ForestNETLib.Core.Helper.IsFloat(p_s_value))
                {
            ...
            public static string TransposeFloat(Object? p_o_value, int p_i_amountDigits, int p_i_amountFractionDigits, string? p_s_decimalSeparator, string? p_s_groupSeparator)
            {
                ...
                if (p_o_value is Single f_foo)
                {
                    ...
                    if ((!ForestNETLib.Core.Helper.IsStringEmpty(p_s_decimalSeparator)) && ((p_s_decimalSeparator ?? "").Equals("$")))
                    {
                    ...
                    if ((!ForestNETLib.Core.Helper.IsStringEmpty(p_s_groupSeparator)) && ((p_s_groupSeparator ?? "").Equals("$")))
                    {
            ...
            public static Object? TransposeDouble(string? p_s_value, int p_i_positionDecimalSeparator)
            {
                ...
                /* check double value */
                if (!ForestNETLib.Core.Helper.IsDouble(p_s_value))
                {
            ...
            public static Object? TransposeDecimal(string? p_s_value, int p_i_positionDecimalSeparator)
            {
                ...
                /* check decimal value */
                if (!ForestNETLib.Core.Helper.IsDecimal(p_s_value))
                {

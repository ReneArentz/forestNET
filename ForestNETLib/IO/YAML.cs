    ...
    public class YAML
    {
        ...
        public int AmountWhiteSpacesindentation
        {
            ...
            set
            {
                ...
                ForestNETLib.Core.Global.ILogConfig("updates amount of white spaces indentation to '" + this.i_amountWhiteSpacesindentation + "'");
            }
        }
        ...
        public string StringQuote
        {
            ...
            set
            {
                ...
                ForestNETLib.Core.Global.ILogConfig("updates string quote to '" + this.s_stringQuote + "'");
        ...
        public YAML(List<string> p_a_yamlSchemaFileLines, int p_i_amountWhiteSpacesindentation, string p_s_stringQuote)
        {
            ...
            ForestNETLib.Core.Global.ILogConfig("yaml schema file lines validated");
            ...
            ForestNETLib.Core.Global.ILogConfig("yaml schema parsed");
        ...
        public YAML(string p_s_file, int p_i_amountWhiteSpacesindentation, string p_s_stringQuote)
        {
            ...
            ForestNETLib.Core.Global.ILogConfig("yaml schema file validated");
        ...
        private void SetSchema(bool p_b_rootIsUnparsedSchema)
        {
            ...
            {
                if (ForestNETLib.Core.Global.IsILevel((byte)ForestNETLib.Log.Level.MASS)) ForestNETLib.Core.Global.ILogMass("Unparsed YAML-Schema: " + this.s_lineBreak + this.Root);
                ...
                ForestNETLib.Core.Global.ILogConfig("yaml schema elements parsed");
                ...
                if (this.o_properties != null)
                {
                    ...
                    if (this.o_properties.Children.Count > 0)
                    {
                        ...
                        ForestNETLib.Core.Global.ILogConfig("added all 'properties' from yaml schema to root");
                    }
                    ...
                    { /* we have 'Reference' in properties */
                        ...
                        ForestNETLib.Core.Global.ILogConfig("set 'reference' from yaml schema as root 'reference'");
                    }
                }
            }

            if (ForestNETLib.Core.Global.IsILevel((byte)ForestNETLib.Log.Level.MASS)) ForestNETLib.Core.Global.ILogMass("Parsed YAML-Schema: " + this.s_lineBreak + this.Root);

            this.o_schema = this.Root;

            ForestNETLib.Core.Global.ILogConfig("set yaml root element as schema element");
        }
        ...
        public List<string> ValidateYAML(string p_s_yamlFile)
        {
            ...
            if (!ForestNETLib.IO.File.Exists(p_s_yamlFile))
            {
                throw new ArgumentException("File[" + p_s_yamlFile + "] does not exist.");
            }

            /* open yaml file */
            ForestNETLib.IO.File o_file = new(p_s_yamlFile, false);

            /* load file content into string */
            string s_fileContent = o_file.FileContent;

            ForestNETLib.Core.Global.ILogConfig("yaml file accessed and content read");
            ...
            ForestNETLib.Core.Global.ILogConfig("yaml file content transferred to array");
        ...
        private void ValidateYAMLRecursive(int p_i_min, int p_i_max, List<string> p_a_lines, int p_i_whiteSpaceindentation, bool p_b_textBlock)
        {
            ...
            for (int i_min = p_i_min; i_min < p_i_max; i_min++)
            {
                ...
                ForestNETLib.Core.Global.ILogFiner(s_line);

                /* check if line has any content */
                if ((s_line.Length == 0) || (s_line.Equals("...")))
                {
                    ForestNETLib.Core.Global.ILogFiner("(" + (i_min + 1) + ")|NULL|");
                ...
                if (s_line[p_i_whiteSpaceindentation] == ' ')
                {
                    ...
                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "block goes from (" + (i_min + 1) + ") to (" + (i_max) + ") with indentation '" + i + "'");
                ...
                if (!ForestNETLib.Core.Helper.MatchesRegex(s_key, "[a-zA-Z0-9-_]*"))
                {
                ...
                if ((!s_value.Equals("null")) && (!s_value.Equals(this.s_stringQuote + this.s_stringQuote)) && (s_value.Length > 0))
                {
                    ...
                    { /* check for invalid characters on value's first position */
                        if (!((ForestNETLib.Core.Helper.IsInteger(s_value)) || (ForestNETLib.Core.Helper.IsDouble(s_value))))
                ...
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "(" + (i_min + 1) + ")|key=" + s_key + "|value=" + s_value + "|" + b_newElementForCollection + "|" + p_b_textBlock + "|");
            }
        }
        ...
        public static YAMLValueType GetYAMLValueType(string? p_s_yamlValue)
        {
            ...
            /* get yaml value type */
            if ((p_s_yamlValue == null) || (ForestNETLib.Core.Helper.IsStringEmpty(p_s_yamlValue)))
            {
                e_yamlValueType = YAMLValueType.Null;
            }
            else if (ForestNETLib.Core.Helper.IsDateTime(p_s_yamlValue))
            {
        ...
        public YAMLElement? ParseYAML(int p_i_min, int p_i_max, List<string> p_a_lines, int p_i_whiteSpaceindentation, YAMLElement p_o_yamlElement, bool p_b_parseSchema)
        {
            ...
            for (int i_min = p_i_min; i_min < p_i_max; i_min++)
            {
                ...
                if (s_line[p_i_whiteSpaceindentation] == ' ')
                {
                    ...
                    {
                        ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "store reference: " + s_reference);
                    ...
                    if ((!b_collectionLevelFlag) || (!s_key.Equals("null")))
                    {
                        if (!s_key.Equals("null"))
                        {
                            if (o_yamlOldCurrentLevelElement != null)
                            {
                                ...
                                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "array object before is finished after new element for collection appeared and array level flag is still 'true'");
                            }
                        }

                        b_collectionLevelFlag = true;

                        ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "new array object");
                ...
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "(" + (i_min + 1) + ")|key=" + s_key + "|value=" + s_value + "|" + b_newElementForCollection + "|");
                ...
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + o_yamlCurrentLevelElement.Name + ".Children.add(" + o_yamlElement.Name + ");");

                o_yamlCurrentLevelElement.Children.Add(o_yamlElement);

                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "p_o_yamlElement = " + o_yamlElement.Name + ";");
            ...
            if ((b_collectionLevelFlag) && (!p_b_parseSchema))
            {
                ...
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "array object before is finished after iteration");
            }

            if (p_o_yamlElement.Name.Equals(o_yamlCurrentLevelElement?.Name))
            {
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "return " + p_o_yamlElement.Name);
                return p_o_yamlElement;
            }
            else
            {
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "return " + o_yamlCurrentLevelElement?.Name);
        ...
        private void ParseYAMLSchemaElements(YAMLElement p_o_yamlSchemaElement)
        {
            if (p_o_yamlSchemaElement.Children.Count > 0)
            {
                ...
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "element: '" + p_o_yamlSchemaElement.Name + "' - array=" + b_array + "|object=" + b_object + "|properties=" + b_properties + "|items=" + b_items + "|");
                ...
                foreach (YAMLElement o_yamlChild in p_o_yamlSchemaElement.Children)
                {
                    ...
                    if (ForestNETLib.Core.Helper.IsStringEmpty(o_yamlChild.Value))
                    {
                        e_yamlValueType = YAMLValueType.Object;
                    }
                    else
                    ...
                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + o_yamlChild.Name + "(" + e_yamlValueType + ") of " + p_o_yamlSchemaElement.Name);
                    ...
                    if (o_yamlChild.Level == 0)
                    {
                        if ((o_yamlChild.Name.ToLower().Equals("definitions")) || (o_yamlChild.Name.ToLower().Equals("properties")))
                        {
                            ...
                            {
                                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "save current element(" + this.o_currentElement?.Name + ") in temporary variable");

                                /* save current element in temporary variable */
                                YAMLElement? o_oldCurrentElement = this.o_currentElement;

                                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "start recursion for: " + o_yamlChild.Name + " = (" + e_yamlValueType + ") for " + this.o_currentElement?.Name);
                                ...
                                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "end recursion for " + this.o_currentElement?.Name + ": " + o_yamlChild.Name + " = (" + e_yamlValueType + ")");

                                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "reset current element(" + this.o_currentElement?.Name + ") from temporary variable(" + o_oldCurrentElement?.Name + ")");
                    ...
                    if (e_yamlValueType == YAMLValueType.Object)
                    {
                        ...
                        if (!b_skip)
                        { /* new object */
                            ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + o_yamlChild.Name + " = (" + e_yamlValueType + ")");
                            ...
                            if (o_yamlChild.Name.ToLower().Equals("properties"))
                            {
                                ...
                                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "end recursion for: " + o_yamlChild.Name + " = (" + e_yamlValueType + ")");
                            }
                            else
                            {
                                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "save current element(" + this.o_currentElement?.Name + ") in temporary variable");
                                ...
                                if (b_handleRootItems)
                                {
                                    ...
                                    {
                                        ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "setReference for (" + this.o_currentElement?.Name + ") with object(" + o_newYAMLElement.Children[0].Name + ")");
                    ...
                    {
                        ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + o_yamlChild.Name + " = " + o_yamlChild.Value + " (" + e_yamlValueType + ") for " + this.o_currentElement?.Name);
        ...
        public File YamlEncode(Object? p_o_object, string p_s_yamlFile, bool p_b_overwrite)
        {
            ...
            if (ForestNETLib.Core.Global.IsILevel((byte)ForestNETLib.Log.Level.MASS)) ForestNETLib.Core.Global.ILogMass("Encoded YAML:" + this.s_lineBreak + s_yaml);
            ...
            /* open (new) file */
            ForestNETLib.IO.File o_file = new(p_s_yamlFile, !p_b_overwrite);
        ...
        private string YamlEncodeRecursive(YAMLElement p_o_yamlSchemaElement, Object? p_o_object, bool p_b_parentIsCollection)
        {
            ...
            if ((ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.Type)) && (ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.MappingClass)))
            {
            ...
            if ((p_o_yamlSchemaElement.Type == null) || (ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.Type)))
            {
            ...
            if (ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.MappingClass))
            {
            ...
            {
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "cast schema-object(" + p_o_yamlSchemaElement.Name + ") with schema-mapping(" + p_o_yamlSchemaElement.PrintMapping() + ") and p_o_object(" + p_o_object?.GetType().FullName + "), castonly=" + (p_o_yamlSchemaElement.MappingClass.Equals(p_o_object?.GetType().FullName)));
                ...
                if (o_object == null)
                {
                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "casted schema-object(" + p_o_yamlSchemaElement.Name + ") with schema-mapping(" + p_o_yamlSchemaElement.PrintMapping() + ") is null");
                    ...
                    else
                    {
                        ...
                        if (!ForestNETLib.Core.Helper.IsStringEmpty(s_yamlParentName))
                        {
                ...
                else
                {
                    ...
                    if (p_o_yamlSchemaElement.Reference != null)
                    {
                        ...
                        if (p_o_yamlSchemaElement.Reference.Children.Count < 1)
                        {
                            ...
                            else
                            {
                                ...
                                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "encode schema-object(" + p_o_yamlSchemaElement.Name + ") with its reference(" + p_o_yamlSchemaElement.Reference.Name + ") and schema-mapping(" + p_o_yamlSchemaElement.PrintMapping() + ") which has another reference with recursion");
                        ...
                        {
                            ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "encode schema-object(" + p_o_yamlSchemaElement.Name + ") with its reference(" + p_o_yamlSchemaElement.Reference.Name + ") which has children");
                    ...
                    if (b_childrenIteration)
                    {
                        ...
                        {
                            ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + "encode schema-object's(" + p_o_yamlSchemaElement.Name + ") child(" + o_yamlElement.Name + ") with schema-mapping(" + p_o_yamlSchemaElement.PrintMapping() + ") with recursion");
            ...
            else if (p_o_yamlSchemaElement.Type.ToLower().Equals("array"))
            {
                if (!ForestNETLib.Core.Helper.IsStringEmpty(s_yamlParentName))
                {
                    ...
                    ((p_o_yamlSchemaElement.Reference == null) && (p_o_yamlSchemaElement.Children.Count == 1) && (p_o_yamlSchemaElement.Children[0].Name.ToLower().Equals("items")) && (ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.Children[0].Type)) && (ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.Children[0].MappingClass)))
                )
                {
                    s_yaml += this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": " + this.s_lineBreak;
                }
                ...
                if (p_o_yamlSchemaElement.Reference != null)
                {
                    ...
                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "encode schema-array(" + p_o_yamlSchemaElement.Name + ") with its reference(" + p_o_yamlSchemaElement.Reference.Name + ") which has children");
                }
                else
                {
                    if (p_o_yamlSchemaElement.Children.Count != 1)
                    ...
                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "encode schema-array(" + p_o_yamlSchemaElement.Name + ") with child(items) which has children");
                }

                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "encode schema-array(" + p_o_yamlSchemaElement.Name + ") - and cast object with p_o_object(" + p_o_object?.GetType().FullName + ") and schema-mapping(" + p_o_yamlSchemaElement.PrintMapping() + "), castonly if List=" + ((p_o_object != null) && (p_o_object.GetType().IsGenericType) && (p_o_object.GetType().GetGenericTypeDefinition() == typeof(List<>))));
                ...
                else if (o_object != null)
                {
                    ...
                    for (int i = 0; i < a_objects.Count; i++)
                    {
                        ...
                        if (a_objects[i] == null)
                        {
                            ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + "encode schema-array(" + p_o_yamlSchemaElement.Name + ") with array element(null) and schema-mapping(" + p_o_yamlSchemaElement.PrintMapping() + ")");
                        ...
                        {
                            ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + "encode schema-array(" + p_o_yamlSchemaElement.Name + ") with primitive array element(#" + (i + 1) + ") and schema-mapping(" + p_o_yamlSchemaElement.PrintMapping() + ")");
                        ...
                        {
                            ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + "encode schema-array(" + p_o_yamlSchemaElement.Name + ") with array element(" + a_objects[i]?.GetType().FullName + ") and schema-mapping(" + p_o_yamlSchemaElement.PrintMapping() + ") with recursion");
            ...
            else
            {
                ...
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "encode schema-property(" + p_o_yamlSchemaElement.Name + ") with p_o_object(" + p_o_object?.GetType().FullName + ")");

                /* get object property if we have not an array with items */
                if (!p_o_yamlSchemaElement.Name.ToLower().Equals("items"))
                {
                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "encode schema-property(" + p_o_yamlSchemaElement.Name + "), cast object with p_o_object(" + p_o_object?.GetType().FullName + ")");

                    /* get object property of current yaml element */
                    o_object = this.CastObject(p_o_yamlSchemaElement, p_o_object);
                }

                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "encode schema-property(" + p_o_yamlSchemaElement.Name + "), cast string from object with p_o_object(" + p_o_object?.GetType().FullName + ") and schema-type(" + p_o_yamlSchemaElement.Type + ")");
        ...
        private Object? CastObject(YAMLElement p_o_yamlElement, Object? p_o_object, bool b_castOnly)
        {
            ...
            else
            {
                ...
                if (!ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlElement.Mapping))
                {
        ...
        private void CheckRestriction(string? p_s_value, YAMLRestriction p_o_yamlRestriction, YAMLElement p_o_yamlElement)
        {
            ...
            else if (p_o_yamlRestriction.Name.ToLower().Equals("pattern"))
            {
                ...
                {
                    if (!ForestNETLib.Core.Helper.MatchesRegex(p_s_value, p_o_yamlRestriction.StrValue))
                    {
        ...
        public bool ValidateAgainstSchema(string p_s_yamlFile)
        {
            ...
            ForestNETLib.Core.Global.ILogFinest("read all lines from yaml file '" + p_s_yamlFile + "'");
        ...
        public bool ValidateAgainstSchema(List<string> p_a_yamlLines)
        {
            ...
            ForestNETLib.Core.Global.ILogFinest("validated yaml content lines");
            ...
            ForestNETLib.Core.Global.ILogFinest("parsed yaml content lines");
            ...
            if (ForestNETLib.Core.Global.IsILevel((byte)ForestNETLib.Log.Level.MASS)) ForestNETLib.Core.Global.ILogMass("YAML-Schema:" + ForestNETLib.IO.File.NEWLINE + this.o_schema);
            if (ForestNETLib.Core.Global.IsILevel((byte)ForestNETLib.Log.Level.MASS)) ForestNETLib.Core.Global.ILogMass("YAML-Root-Element:" + ForestNETLib.IO.File.NEWLINE + this.Root);
        ...
        private bool ValidateAgainstSchemaRecursive(YAMLElement p_o_yamlDataElement, YAMLElement p_o_yamlSchemaElement)
        {
            ...
            if (p_o_yamlSchemaElement.Type.ToLower().Equals("object"))
            {
                ...
                if (p_o_yamlDataElement.Children.Count > 0)
                {
                    ...
                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": create new schema-object instance with mapping[" + p_o_yamlSchemaElement.PrintMapping() + "] and type[" + s_objectType + "]");
                    ...
                    if (p_o_yamlSchemaElement.Reference != null)
                    {
                        ...
                        if (p_o_yamlSchemaElement.Reference.Children.Count < 1)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": get schema-object[" + p_o_yamlSchemaElement.MappingClass + "] with reference[" + p_o_yamlSchemaElement.Reference.Name + "]");
                        ...
                        {
                            ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "update current schema-element[" + p_o_yamlSchemaElement.Name + "](" + p_o_yamlSchemaElement.PrintMapping() + ") with reference[" + p_o_yamlSchemaElement.Reference.Name + "](" + p_o_yamlSchemaElement.Reference.PrintMapping() + ")");
                    ...
                    if (b_childrenIteration)
                    {
                        ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": get schema-object with type[" + p_o_yamlSchemaElement.MappingClass + "] and children[" + p_o_yamlSchemaElement.Children.Count + "]");
                        ...
                        if (p_o_yamlDataElement.Children.Count > 0)
                        {
                            ...
                            {
                                ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + "compare schema-child-name(" + p_o_yamlSchemaElement.Children[i].Name + ") with data-child-name(" + p_o_yamlDataElement.Children[j].Name + ")");
            ...
            else if (p_o_yamlSchemaElement.Type.ToLower().Equals("array"))
            {
                ...
                if (ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlDataElement.Value))
                { /* we have multiple minor objects for current array */
                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": get schema-array with mapping[" + p_o_yamlSchemaElement.PrintMapping() + "]");
                    ...
                    { /* if we have objects to the new array */
                        ...
                        for (int i = 0; i < p_o_yamlDataElement.Children.Count; i++)
                        {
                            ...
                            ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + " return value of " + p_o_yamlDataElement.Name + ": " + b_return);
                ...
                { /* array objects must be retrieved out of value property */
                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": handle array value = " + p_o_yamlDataElement.Value + " - mapping[" + p_o_yamlSchemaElement.PrintMapping() + "]");

                    /* set array with values if we have any values */
                    if ((p_o_yamlDataElement.Value != null) && (!ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlDataElement.Value)) && (!p_o_yamlDataElement.Value.Equals("[]")))
                    {
                        ...
                        foreach (string s_value in a_values)
                        {
                            ...
                            ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + "add value[" + (o_returnObject ?? "null") + "] to list of " + p_o_yamlDataElement.Name + ", type[" + ((o_returnObject == null) ? "null" : o_returnObject.GetType().FullName) + "]");
                        }
                    }
                    else if (b_required)
            ...
            {
                ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": handle value = " + p_o_yamlDataElement.Value + " - mapping[" + p_o_yamlSchemaElement.PrintMapping() + "]");
                ...
                if ((ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.Mapping)) && (ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.MappingClass)))
                {
            ...
            ForestNETLib.Core.Global.ILogFine(this.PrintIndentation() + "return " + b_return);
        ...
        private Object? YamlDecodeRecursive(YAMLElement p_o_yamlDataElement, YAMLElement p_o_yamlSchemaElement, Object? p_o_object)
        {
            ...
            if (p_o_yamlSchemaElement.Type.ToLower().Equals("object"))
            {
                ...
                else
                {
                    ...
                    if (!ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.Mapping))
                    {
                    ...
                    if (p_o_yamlSchemaElement.Reference != null)
                    {
                        ...
                        if (p_o_yamlSchemaElement.Reference.Children.Count < 1)
                        {
                            ...
                            else
                            {
                                ...
                                if (p_o_yamlSchemaElement.Name.Equals(p_o_yamlDataElement.Name))
                                {
                                    ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": get schema-object[" + o_object?.GetType().FullName + "] with reference[" + p_o_yamlSchemaElement.Reference.Name + "]");
                    ...
                    if (b_childrenIteration)
                    {
                        ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": get schema-object with type[" + o_object?.GetType().FullName + "] and children[" + p_o_yamlSchemaElement.Children.Count + "]");
                        ...
                        {
                            ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + p_o_yamlSchemaElement.Name + ": set schema-object[" + o_object?.GetType().FullName + "] to current object[" + p_o_object?.GetType().FullName + "] with mapping[" + s_objectMapping + "]");
            ...
            else if (p_o_yamlSchemaElement.Type.ToLower().Equals("array"))
            {
                ...
                if ((p_o_yamlSchemaElement.Children.Count > 0) && (p_o_yamlSchemaElement.Children[0].PrimitiveArray))
                {
                    ...
                    else
                    {
                        ...
                        else if (!(ForestNETLib.Core.Helper.IsStringEmpty(p_o_yamlSchemaElement.MappingClass)))
                        {
                ...
                else
                {
                    ...
                    { /* we have to retrieve the list object */
                        ForestNETLib.Core.Global.ILogFiner(this.PrintIndentation() + "p_o_object(" + p_o_object.GetType().FullName + ") != null, get list property " + p_o_yamlSchemaElement.Name);
                ...
                { /* we have multiple minor objects for current array */
                    ...
                    { /* if we have objects to the new array */
                        ...
                        for (int i = 0; i < p_o_yamlDataElement.Children.Count; i++)
                        {
                            ...
                            ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + "add return value to list of " + p_o_yamlDataElement.Name + ", type[" + ((o_returnObject == null) ? "object is null" : o_returnObject.GetType().FullName) + "]");
            ...
            ForestNETLib.Core.Global.ILogFine(this.PrintIndentation() + "return " + ((p_o_object == null) ? "null" : p_o_object.GetType().FullName));
        ...
        private void SetFieldOrProperty(YAMLElement p_o_yamlSchemaElement, Object? p_o_object, string? p_s_objectValue)
        {
            ...
            if (this.UseProperties)
            {
                ...
                {
                    ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + o_exc.Message + " - with type[" + p_o_yamlSchemaElement.Type + "] - try another cast with type[" + o_propertyInfo.PropertyType.FullName + "]");
            ...
            else
            {
                ...
                {
                    ForestNETLib.Core.Global.ILogFinest(this.PrintIndentation() + o_exc.Message + " - with type[" + p_o_yamlSchemaElement.Type + "]  - try another cast with type[" + o_fieldInfo.FieldType.FullName + "]");
        ...
        public class YAMLRestriction
        {
            ...
            override public string ToString()
            {
                string s_foo = ForestNETLib.IO.File.NEWLINE + this.PrintTabs() + "\t" + "YAMLRestriction: ";
